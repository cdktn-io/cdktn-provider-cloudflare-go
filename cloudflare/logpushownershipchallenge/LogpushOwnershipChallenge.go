...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/logpushownershipchallenge/internal"
...
func (l *jsiiProxy_LogpushOwnershipChallenge) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogpushOwnershipChallenge) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogpushOwnershipChallenge) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
