...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) BucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketName",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) BucketNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketNameInput",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) QueueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueId",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) QueueIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueIdInput",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) QueueName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueName",
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) Rules() DataCloudflareR2BucketEventNotificationRulesList {
	var returns DataCloudflareR2BucketEventNotificationRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_DataCloudflareR2BucketEventNotification) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareR2BucketEventNotification(scope constructs.Construct, id *string, config *DataCloudflareR2BucketEventNotificationConfig) DataCloudflareR2BucketEventNotification {
	...
	if err := validateNewDataCloudflareR2BucketEventNotificationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareR2BucketEventNotification_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareR2BucketEventNotification.DataCloudflareR2BucketEventNotification",
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareR2BucketEventNotification) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
