...
func (j *jsiiProxy_ZeroTrustDexTest) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustDexTest) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustDexTest) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustDexTest) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustDexTest) Targeted() cdktn.IResolvable {
...
func (j *jsiiProxy_ZeroTrustDexTest) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZeroTrustDexTest)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZeroTrustDexTest)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZeroTrustDexTest)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZeroTrustDexTest_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustDexTest) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDexTest) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustDexTest) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDexTest) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDexTest) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
