...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customerGreEndpoint", GoGetter: "CustomerGreEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "customerGreEndpointInput", GoGetter: "CustomerGreEndpointInput"},
