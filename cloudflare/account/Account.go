...
func (a *jsiiProxy_Account) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_Account) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_Account) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
