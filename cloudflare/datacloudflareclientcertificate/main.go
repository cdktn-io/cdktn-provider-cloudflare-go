...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareClientCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareClientCertificateCertificateAuthority)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareClientCertificateCertificateAuthorityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
