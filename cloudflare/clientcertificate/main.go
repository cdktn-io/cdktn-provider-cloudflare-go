...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "reactivate", GoGetter: "Reactivate"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ClientCertificateCertificateAuthority)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.clientCertificate.ClientCertificateCertificateAuthorityOutputReference",
		reflect.TypeOf((*ClientCertificateCertificateAuthorityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ClientCertificateConfig)(nil)).Elem(),
	)
}
