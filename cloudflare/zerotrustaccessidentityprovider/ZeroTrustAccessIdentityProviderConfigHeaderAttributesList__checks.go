...
func (z *jsiiProxy_ZeroTrustAccessIdentityProviderConfigHeaderAttributesList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProviderConfigHeaderAttributesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProviderConfigHeaderAttributesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
