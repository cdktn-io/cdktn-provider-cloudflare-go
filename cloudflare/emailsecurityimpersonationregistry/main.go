...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EmailSecurityImpersonationRegistry)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "directoryNodeIdInput", GoGetter: "DirectoryNodeIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "externalDirectoryNodeIdInput", GoGetter: "ExternalDirectoryNodeIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "isEmailRegexInput", GoGetter: "IsEmailRegexInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDirectoryNodeId", GoMethod: "ResetDirectoryNodeId"},
			_jsii_.MemberMethod{JsiiMethod: "resetExternalDirectoryNodeId", GoMethod: "ResetExternalDirectoryNodeId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EmailSecurityImpersonationRegistryConfig)(nil)).Elem(),
	)
}
