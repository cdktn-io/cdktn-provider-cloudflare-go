...
func (j *jsiiProxy_DataCloudflareLoadBalancerPool) HealthSources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"healthSources",
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
