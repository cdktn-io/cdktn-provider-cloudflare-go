...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dnsFirewallIpCount", GoGetter: "DnsFirewallIpCount"},
			_jsii_.MemberProperty{JsiiProperty: "dnsFirewallIpCountInput", GoGetter: "DnsFirewallIpCountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDnsFirewallIpCount", GoMethod: "ResetDnsFirewallIpCount"},
