...
func (d *jsiiProxy_DataCloudflareCustomHostnameFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCustomHostnameFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
