...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntryProfilesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustDlpIntegrationEntryProfilesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustDlpIntegrationEntryProfilesList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustDlpIntegrationEntryProfilesList_Override(d DataCloudflareZeroTrustDlpIntegrationEntryProfilesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntryProfilesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntryProfilesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntryProfilesList) Resolve(context cdktf.IResolveContext) interface{} {
