...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) AllowAllHeaders() cdktf.IResolvable {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) AllowAllMethods() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"allowAllMethods",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) AllowAllOrigins() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"allowAllOrigins",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) AllowCredentials() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"allowCredentials",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference_Override(d DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultCorsHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
