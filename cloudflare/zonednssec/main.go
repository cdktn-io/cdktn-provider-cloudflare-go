...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dnssecMultiSignerInput", GoGetter: "DnssecMultiSignerInput"},
			_jsii_.MemberProperty{JsiiProperty: "dnssecPresigned", GoGetter: "DnssecPresigned"},
			_jsii_.MemberProperty{JsiiProperty: "dnssecPresignedInput", GoGetter: "DnssecPresignedInput"},
			_jsii_.MemberProperty{JsiiProperty: "dnssecUseNsec3", GoGetter: "DnssecUseNsec3"},
			_jsii_.MemberProperty{JsiiProperty: "dnssecUseNsec3Input", GoGetter: "DnssecUseNsec3Input"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDnssecMultiSigner", GoMethod: "ResetDnssecMultiSigner"},
			_jsii_.MemberMethod{JsiiMethod: "resetDnssecPresigned", GoMethod: "ResetDnssecPresigned"},
			_jsii_.MemberMethod{JsiiMethod: "resetDnssecUseNsec3", GoMethod: "ResetDnssecUseNsec3"},
