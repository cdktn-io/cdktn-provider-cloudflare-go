...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *map[string]*PagesProjectDeploymentConfigsPreviewQueueProducers; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewPagesProjectDeploymentConfigsPreviewQueueProducersMapParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
