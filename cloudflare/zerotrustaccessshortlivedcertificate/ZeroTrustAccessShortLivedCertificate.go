...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustaccessshortlivedcertificate/internal"
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
