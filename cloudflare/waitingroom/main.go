...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cookieAttributesInput", GoGetter: "CookieAttributesInput"},
			_jsii_.MemberProperty{JsiiProperty: "cookieSuffix", GoGetter: "CookieSuffix"},
			_jsii_.MemberProperty{JsiiProperty: "cookieSuffixInput", GoGetter: "CookieSuffixInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enabledOriginCommandsInput", GoGetter: "EnabledOriginCommandsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAdditionalRoutes", GoMethod: "PutAdditionalRoutes"},
			_jsii_.MemberMethod{JsiiMethod: "putCookieAttributes", GoMethod: "PutCookieAttributes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCookieAttributes", GoMethod: "ResetCookieAttributes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledOriginCommands", GoMethod: "ResetEnabledOriginCommands"},
