...
func (d *jsiiProxy_DataCloudflareLogpushJobsResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareLogpushJobsResultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
