...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automaticAdvertisementInput", GoGetter: "AutomaticAdvertisementInput"},
			_jsii_.MemberProperty{JsiiProperty: "bandwidthThreshold", GoGetter: "BandwidthThreshold"},
			_jsii_.MemberProperty{JsiiProperty: "bandwidthThresholdInput", GoGetter: "BandwidthThresholdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBandwidthThreshold", GoMethod: "ResetBandwidthThreshold"},
			_jsii_.MemberMethod{JsiiMethod: "resetDuration", GoMethod: "ResetDuration"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPacketThreshold", GoMethod: "ResetPacketThreshold"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrefixMatch", GoMethod: "ResetPrefixMatch"},
			_jsii_.MemberMethod{JsiiMethod: "resetZscoreSensitivity", GoMethod: "ResetZscoreSensitivity"},
			_jsii_.MemberMethod{JsiiMethod: "resetZscoreTarget", GoMethod: "ResetZscoreTarget"},
			...
			_jsii_.MemberProperty{JsiiProperty: "zscoreSensitivityInput", GoGetter: "ZscoreSensitivityInput"},
			_jsii_.MemberProperty{JsiiProperty: "zscoreTarget", GoGetter: "ZscoreTarget"},
			_jsii_.MemberProperty{JsiiProperty: "zscoreTargetInput", GoGetter: "ZscoreTargetInput"},
		},
		func() interface{} {
