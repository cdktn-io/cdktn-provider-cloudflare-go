...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lockDownsId", GoGetter: "LockDownsId"},
			_jsii_.MemberProperty{JsiiProperty: "lockDownsIdInput", GoGetter: "LockDownsIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLockDownsId", GoMethod: "ResetLockDownsId"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "createdOn", GoGetter: "CreatedOn"},
			_jsii_.MemberProperty{JsiiProperty: "createdOnInput", GoGetter: "CreatedOnInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionSearch", GoGetter: "DescriptionSearch"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionSearchInput", GoGetter: "DescriptionSearchInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ipRangeSearch", GoGetter: "IpRangeSearch"},
			_jsii_.MemberProperty{JsiiProperty: "ipRangeSearchInput", GoGetter: "IpRangeSearchInput"},
			_jsii_.MemberProperty{JsiiProperty: "ipSearch", GoGetter: "IpSearch"},
			_jsii_.MemberProperty{JsiiProperty: "ipSearchInput", GoGetter: "IpSearchInput"},
			_jsii_.MemberProperty{JsiiProperty: "modifiedOn", GoGetter: "ModifiedOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCreatedOn", GoMethod: "ResetCreatedOn"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescriptionSearch", GoMethod: "ResetDescriptionSearch"},
			_jsii_.MemberMethod{JsiiMethod: "resetIp", GoMethod: "ResetIp"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpRangeSearch", GoMethod: "ResetIpRangeSearch"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpSearch", GoMethod: "ResetIpSearch"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUriSearch", GoMethod: "ResetUriSearch"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
