...
func (f *jsiiProxy_FirewallRuleFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallRuleFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
