...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPagesProjectDeploymentConfigsPreviewQueueProducersMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PagesProjectDeploymentConfigsPreviewQueueProducersMap {
	_init_.Initialize()
...
func NewPagesProjectDeploymentConfigsPreviewQueueProducersMap_Override(p PagesProjectDeploymentConfigsPreviewQueueProducersMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewQueueProducersMap) Resolve(context cdktn.IResolveContext) interface{} {
