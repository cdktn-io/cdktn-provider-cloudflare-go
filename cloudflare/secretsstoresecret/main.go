...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsStoreSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.secretsStoreSecret.SecretsStoreSecretConfig",
		reflect.TypeOf((*SecretsStoreSecretConfig)(nil)).Elem(),
	)
}
