...
func (l *jsiiProxy_ListItemsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_ListItemsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
