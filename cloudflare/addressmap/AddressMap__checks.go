...
func (a *jsiiProxy_AddressMap) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (a *jsiiProxy_AddressMap) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (a *jsiiProxy_AddressMap) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (a *jsiiProxy_AddressMap) validatePutMembershipsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AddressMapMemberships; received %#v (a %T)", value, value)
		}
	}
...
func validateAddressMap_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
