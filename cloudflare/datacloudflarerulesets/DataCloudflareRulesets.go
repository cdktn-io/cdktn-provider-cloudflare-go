...
func (j *jsiiProxy_DataCloudflareRulesets) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareRulesets) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareRulesets) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareRulesets) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareRulesets) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/rulesets cloudflare_rulesets} Data Source.
...
func (j *jsiiProxy_DataCloudflareRulesets)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareRulesets)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareRulesets)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareRulesets_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareRulesets) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareRulesets) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareRulesets) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
