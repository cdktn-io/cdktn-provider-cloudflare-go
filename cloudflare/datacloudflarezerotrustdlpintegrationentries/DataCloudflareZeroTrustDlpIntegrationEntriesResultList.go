...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntriesResultList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustDlpIntegrationEntriesResultList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustDlpIntegrationEntriesResultList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustDlpIntegrationEntriesResultList_Override(d DataCloudflareZeroTrustDlpIntegrationEntriesResultList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntriesResultList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntriesResultList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpIntegrationEntriesResultList) Resolve(context cdktn.IResolveContext) interface{} {
