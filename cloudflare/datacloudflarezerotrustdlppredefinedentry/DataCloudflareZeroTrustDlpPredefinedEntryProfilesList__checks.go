...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedEntryProfilesList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedEntryProfilesList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataCloudflareZeroTrustDlpPredefinedEntryProfilesListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
