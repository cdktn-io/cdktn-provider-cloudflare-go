...
func (z *jsiiProxy_ZeroTrustTunnelCloudflared) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflared) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflared) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
