...
func (j *jsiiProxy_DataCloudflareDnsFirewall) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall) DeprecateAnyRequests() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall) EcsFallback() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ecsFallback",
...
func (j *jsiiProxy_DataCloudflareDnsFirewall) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareDnsFirewall)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareDnsFirewall)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareDnsFirewall_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareDnsFirewall) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsFirewall) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsFirewall) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareDnsFirewall) ResetAccountId() {
	_jsii_.InvokeVoid(
		d,
		"resetAccountId",
		nil, // no parameters
