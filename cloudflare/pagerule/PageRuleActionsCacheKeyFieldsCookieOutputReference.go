...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/pagerule/internal"
...
func (j *jsiiProxy_PageRuleActionsCacheKeyFieldsCookieOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPageRuleActionsCacheKeyFieldsCookieOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PageRuleActionsCacheKeyFieldsCookieOutputReference {
	_init_.Initialize()
...
func NewPageRuleActionsCacheKeyFieldsCookieOutputReference_Override(p PageRuleActionsCacheKeyFieldsCookieOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PageRuleActionsCacheKeyFieldsCookieOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PageRuleActionsCacheKeyFieldsCookieOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PageRuleActionsCacheKeyFieldsCookieOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PageRuleActionsCacheKeyFieldsCookieOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PageRuleActionsCacheKeyFieldsCookieOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
