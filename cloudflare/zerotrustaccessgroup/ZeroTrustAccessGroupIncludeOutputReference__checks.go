...
func (j *jsiiProxy_ZeroTrustAccessGroupIncludeOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *ZeroTrustAccessGroupInclude; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ZeroTrustAccessGroupIncludeOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewZeroTrustAccessGroupIncludeOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
