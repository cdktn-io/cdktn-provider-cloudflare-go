...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/mtlscertificate/internal"
...
func (m *jsiiProxy_MtlsCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MtlsCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
