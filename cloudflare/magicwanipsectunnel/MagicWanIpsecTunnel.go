...
func (m *jsiiProxy_MagicWanIpsecTunnel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MagicWanIpsecTunnel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MagicWanIpsecTunnel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
