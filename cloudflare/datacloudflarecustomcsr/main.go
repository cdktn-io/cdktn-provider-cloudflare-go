...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomCsr)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customCsrIdInput", GoGetter: "CustomCsrIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomCsrId", GoMethod: "ResetCustomCsrId"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareCustomCsr.DataCloudflareCustomCsrConfig",
		reflect.TypeOf((*DataCloudflareCustomCsrConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareCustomCsr.DataCloudflareCustomCsrFilter",
		reflect.TypeOf((*DataCloudflareCustomCsrFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareCustomCsr.DataCloudflareCustomCsrFilterOutputReference",
		reflect.TypeOf((*DataCloudflareCustomCsrFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
