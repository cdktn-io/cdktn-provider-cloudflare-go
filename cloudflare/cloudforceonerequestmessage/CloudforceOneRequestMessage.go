...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/cloudforceonerequestmessage/internal"
...
func (j *jsiiProxy_CloudforceOneRequestMessage) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Author() *string {
	var returns *string
	_jsii_.Get(
		j,
		"author",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Content() *string {
	var returns *string
	_jsii_.Get(
		j,
		"content",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) ContentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentInput",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Created() *string {
	var returns *string
	_jsii_.Get(
		j,
		"created",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Id() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Node() constructs.Node {
...
func (j *jsiiProxy_CloudforceOneRequestMessage) RequestId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requestId",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) RequestIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"requestIdInput",
...
func (j *jsiiProxy_CloudforceOneRequestMessage) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudforceOneRequestMessage) Updated() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updated",
...
func NewCloudforceOneRequestMessage(scope constructs.Construct, id *string, config *CloudforceOneRequestMessageConfig) CloudforceOneRequestMessage {
	...
	if err := validateNewCloudforceOneRequestMessageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func CloudforceOneRequestMessage_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessage",
...
func (c *jsiiProxy_CloudforceOneRequestMessage) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) MoveFromId(id *string) {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) MoveToId(id *string) {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudforceOneRequestMessage) ResetContent() {
	_jsii_.InvokeVoid(
		c,
		"resetContent",
		nil, // no parameters
...
func (c *jsiiProxy_CloudforceOneRequestMessage) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudforceOneRequestMessage) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CloudforceOneRequestMessage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
