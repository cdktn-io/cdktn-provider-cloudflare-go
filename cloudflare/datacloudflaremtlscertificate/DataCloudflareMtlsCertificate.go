...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v14/datacloudflaremtlscertificate/internal"
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate) Ca() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareMtlsCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareMtlsCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareMtlsCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareMtlsCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
