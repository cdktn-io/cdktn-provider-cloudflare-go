...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "numTables", GoGetter: "NumTables"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "primaryLocationHint", GoGetter: "PrimaryLocationHint"},
			_jsii_.MemberProperty{JsiiProperty: "primaryLocationHintInput", GoGetter: "PrimaryLocationHintInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putReadReplication", GoMethod: "PutReadReplication"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetReadReplication", GoMethod: "ResetReadReplication"},
