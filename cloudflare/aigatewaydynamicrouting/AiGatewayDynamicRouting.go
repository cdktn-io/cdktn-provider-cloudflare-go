...
func (j *jsiiProxy_AiGatewayDynamicRouting) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AiGatewayDynamicRouting) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AiGatewayDynamicRouting) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AiGatewayDynamicRouting) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AiGatewayDynamicRouting) Success() cdktn.IResolvable {
...
func (j *jsiiProxy_AiGatewayDynamicRouting) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AiGatewayDynamicRouting)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AiGatewayDynamicRouting)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AiGatewayDynamicRouting)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AiGatewayDynamicRouting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AiGatewayDynamicRouting) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AiGatewayDynamicRouting) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AiGatewayDynamicRouting) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AiGatewayDynamicRouting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AiGatewayDynamicRouting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AiGatewayDynamicRouting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
