...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/argotieredcaching/internal"
...
func (j *jsiiProxy_ArgoTieredCaching) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ArgoTieredCaching) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ArgoTieredCaching) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ArgoTieredCaching) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ArgoTieredCaching) ModifiedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modifiedOn",
...
func (j *jsiiProxy_ArgoTieredCaching) Node() constructs.Node {
...
func (j *jsiiProxy_ArgoTieredCaching) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ArgoTieredCaching) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_ArgoTieredCaching) ValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueInput",
...
func (j *jsiiProxy_ArgoTieredCaching) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ArgoTieredCaching) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewArgoTieredCaching(scope constructs.Construct, id *string, config *ArgoTieredCachingConfig) ArgoTieredCaching {
	...
	if err := validateNewArgoTieredCachingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ArgoTieredCaching_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.argoTieredCaching.ArgoTieredCaching",
...
func (a *jsiiProxy_ArgoTieredCaching) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ArgoTieredCaching) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ArgoTieredCaching) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ArgoTieredCaching) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ArgoTieredCaching) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ArgoTieredCaching) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ArgoTieredCaching) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ArgoTieredCaching) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ArgoTieredCaching) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ArgoTieredCaching) MoveFromId(id *string) {
...
func (a *jsiiProxy_ArgoTieredCaching) MoveToId(id *string) {
...
func (a *jsiiProxy_ArgoTieredCaching) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_ArgoTieredCaching) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ArgoTieredCaching) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ArgoTieredCaching) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_ArgoTieredCaching) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
