...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender) IsRegex() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareEmailSecurityBlockSender)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareEmailSecurityBlockSender_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareEmailSecurityBlockSender) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareEmailSecurityBlockSender) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareEmailSecurityBlockSender) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareEmailSecurityBlockSender) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
