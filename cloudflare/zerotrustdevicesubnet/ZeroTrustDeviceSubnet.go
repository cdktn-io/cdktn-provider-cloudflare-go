...
func (j *jsiiProxy_ZeroTrustDeviceSubnet) Capacity() ZeroTrustDeviceSubnetCapacityOutputReference {
	var returns ZeroTrustDeviceSubnetCapacityOutputReference
	_jsii_.Get(
		j,
		"capacity",
		&returns,
...
func (z *jsiiProxy_ZeroTrustDeviceSubnet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceSubnet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
