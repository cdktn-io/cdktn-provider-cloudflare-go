...
func (l *jsiiProxy_LoadBalancer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LoadBalancer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
