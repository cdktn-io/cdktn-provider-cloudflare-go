...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareSecretsStore)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareSecretsStore.DataCloudflareSecretsStoreConfig",
		reflect.TypeOf((*DataCloudflareSecretsStoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareSecretsStore.DataCloudflareSecretsStoreFilter",
		reflect.TypeOf((*DataCloudflareSecretsStoreFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareSecretsStore.DataCloudflareSecretsStoreFilterOutputReference",
		reflect.TypeOf((*DataCloudflareSecretsStoreFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
