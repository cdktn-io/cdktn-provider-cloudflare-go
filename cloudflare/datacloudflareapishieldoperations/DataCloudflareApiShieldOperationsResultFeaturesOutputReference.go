...
func (d *jsiiProxy_DataCloudflareApiShieldOperationsResultFeaturesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareApiShieldOperationsResultFeaturesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
