...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zonelockdown/internal"
...
func (j *jsiiProxy_ZoneLockdown) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZoneLockdown) CreatedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdOn",
...
func (j *jsiiProxy_ZoneLockdown) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZoneLockdown) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZoneLockdown) ModifiedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modifiedOn",
...
func (j *jsiiProxy_ZoneLockdown) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZoneLockdown) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZoneLockdown)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZoneLockdown)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZoneLockdown)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZoneLockdown_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZoneLockdown) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZoneLockdown) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZoneLockdown) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZoneLockdown) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZoneLockdown) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZoneLockdown) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
