...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.share.ShareConfig",
		reflect.TypeOf((*ShareConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.share.ShareRecipients",
		reflect.TypeOf((*ShareRecipients)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.share.ShareRecipientsList",
		reflect.TypeOf((*ShareRecipientsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ShareRecipientsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "recipientAccountId", GoGetter: "RecipientAccountId"},
			_jsii_.MemberProperty{JsiiProperty: "recipientAccountIdInput", GoGetter: "RecipientAccountIdInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetOrganizationId", GoMethod: "ResetOrganizationId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecipientAccountId", GoMethod: "ResetRecipientAccountId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.share.ShareResources",
		reflect.TypeOf((*ShareResources)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.share.ShareResourcesList",
		reflect.TypeOf((*ShareResourcesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ShareResourcesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceAccountIdInput", GoGetter: "ResourceAccountIdInput"},
