...
func (j *jsiiProxy_DataCloudflareQueueProducersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareQueueProducersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataCloudflareQueueProducersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataCloudflareQueueProducersList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataCloudflareQueueProducersList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataCloudflareQueueProducersList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareQueueProducersList) Get(index *float64) DataCloudflareQueueProducersOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataCloudflareQueueProducersOutputReference
...
func (d *jsiiProxy_DataCloudflareQueueProducersList) ToString() *string {
	var returns *string
