...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflaresnippets/internal"
...
func (j *jsiiProxy_DataCloudflareSnippets) CreatedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdOn",
...
func (j *jsiiProxy_DataCloudflareSnippets) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareSnippets) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareSnippets) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareSnippets) ModifiedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modifiedOn",
...
func (j *jsiiProxy_DataCloudflareSnippets) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareSnippets) SnippetName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snippetName",
...
func (j *jsiiProxy_DataCloudflareSnippets) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareSnippets) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DataCloudflareSnippets) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewDataCloudflareSnippets(scope constructs.Construct, id *string, config *DataCloudflareSnippetsConfig) DataCloudflareSnippets {
	...
	if err := validateNewDataCloudflareSnippetsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareSnippets_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareSnippets.DataCloudflareSnippets",
...
func (d *jsiiProxy_DataCloudflareSnippets) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareSnippets) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareSnippets) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareSnippets) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareSnippets) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareSnippets) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareSnippets) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareSnippets) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareSnippets) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareSnippets) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareSnippets) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareSnippets) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
