...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarewaitingroomevent/internal"
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) DisableSessionRenewal() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) ShuffleAtEventStart() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"shuffleAtEventStart",
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) Suspended() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"suspended",
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomEvent)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareWaitingRoomEvent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareWaitingRoomEvent) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareWaitingRoomEvent) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareWaitingRoomEvent) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareWaitingRoomEvent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
