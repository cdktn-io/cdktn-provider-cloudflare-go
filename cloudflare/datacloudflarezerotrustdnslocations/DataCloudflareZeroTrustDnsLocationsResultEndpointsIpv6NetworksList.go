...
func (j *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList_Override(d DataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsIpv6NetworksList) Resolve(context cdktn.IResolveContext) interface{} {
