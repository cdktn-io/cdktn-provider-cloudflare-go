...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarecloudforceonerequestasset/internal"
...
type jsiiProxy_DataCloudflareCloudforceOneRequestAsset struct {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareCloudforceOneRequestAsset(scope constructs.Construct, id *string, config *DataCloudflareCloudforceOneRequestAssetConfig) DataCloudflareCloudforceOneRequestAsset {
	...
	if err := validateNewDataCloudflareCloudforceOneRequestAssetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareCloudforceOneRequestAsset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareCloudforceOneRequestAsset_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataCloudflareCloudforceOneRequestAsset_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareCloudforceOneRequestAsset.DataCloudflareCloudforceOneRequestAsset",
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
