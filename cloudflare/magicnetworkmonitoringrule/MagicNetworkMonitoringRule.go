...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/magicnetworkmonitoringrule/internal"
...
func (m *jsiiProxy_MagicNetworkMonitoringRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MagicNetworkMonitoringRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
