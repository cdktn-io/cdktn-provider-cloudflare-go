...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustgatewaycertificate/internal"
...
type ZeroTrustGatewayCertificate interface {
	...
	ValidityPeriodDaysInput() *float64
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) ExpiresOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expiresOn",
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) ValidityPeriodDays() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"validityPeriodDays",
...
func (j *jsiiProxy_ZeroTrustGatewayCertificate) ValidityPeriodDaysInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"validityPeriodDaysInput",
		&returns,
	)
	return returns
}
...
func NewZeroTrustGatewayCertificate(scope constructs.Construct, id *string, config *ZeroTrustGatewayCertificateConfig) ZeroTrustGatewayCertificate {
	...
	if err := validateNewZeroTrustGatewayCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ZeroTrustGatewayCertificate_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.zeroTrustGatewayCertificate.ZeroTrustGatewayCertificate",
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) ResetValidityPeriodDays() {
	_jsii_.InvokeVoid(
		z,
		"resetValidityPeriodDays",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustGatewayCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
