...
func (c *jsiiProxy_CustomSsl) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomSsl) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
