...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.organization.OrganizationMetaTenantFlags",
		reflect.TypeOf((*OrganizationMetaTenantFlags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.organization.OrganizationMetaTenantFlagsOutputReference",
		reflect.TypeOf((*OrganizationMetaTenantFlagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "businessAddressInput", GoGetter: "BusinessAddressInput"},
			_jsii_.MemberProperty{JsiiProperty: "businessEmail", GoGetter: "BusinessEmail"},
			_jsii_.MemberProperty{JsiiProperty: "businessEmailInput", GoGetter: "BusinessEmailInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "businessPhoneInput", GoGetter: "BusinessPhoneInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "externalMetadata", GoGetter: "ExternalMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "externalMetadataInput", GoGetter: "ExternalMetadataInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
