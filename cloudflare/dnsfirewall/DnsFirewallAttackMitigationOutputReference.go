...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/dnsfirewall/internal"
...
type DnsFirewallAttackMitigationOutputReference interface {
	...
	SetOnlyWhenUpstreamUnhealthy(val interface{})
	OnlyWhenUpstreamUnhealthyInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) OnlyWhenUpstreamUnhealthy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) OnlyWhenUpstreamUnhealthyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDnsFirewallAttackMitigationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DnsFirewallAttackMitigationOutputReference {
	_init_.Initialize()
...
func NewDnsFirewallAttackMitigationOutputReference_Override(d DnsFirewallAttackMitigationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference)SetOnlyWhenUpstreamUnhealthy(val interface{}) {
...
func (j *jsiiProxy_DnsFirewallAttackMitigationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DnsFirewallAttackMitigationOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DnsFirewallAttackMitigationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DnsFirewallAttackMitigationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DnsFirewallAttackMitigationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DnsFirewallAttackMitigationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
