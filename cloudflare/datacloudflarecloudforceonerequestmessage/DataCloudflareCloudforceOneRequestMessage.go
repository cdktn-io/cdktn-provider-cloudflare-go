...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarecloudforceonerequestmessage/internal"
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) IsFollowOnRequest() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestMessage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareCloudforceOneRequestMessage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestMessage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
