// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for cloudflare.
...
// You can continue to use the cloudflare provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13
