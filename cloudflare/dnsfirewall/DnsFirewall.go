...
func (d *jsiiProxy_DnsFirewall) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DnsFirewall) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DnsFirewall) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
