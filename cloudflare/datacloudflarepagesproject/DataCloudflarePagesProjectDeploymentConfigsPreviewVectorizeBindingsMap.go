...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsMap) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsMap) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsMap)SetTerraformAttribute(val *string) {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsMap) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsMap) Get(key *string) DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsOutputReference {
	if err := d.validateGetParameters(key); err != nil {
		panic(err)
	}
	var returns DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsOutputReference
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewVectorizeBindingsMap) ToString() *string {
	var returns *string
