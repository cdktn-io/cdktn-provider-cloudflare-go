...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequests)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareCloudforceOneRequests_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequests) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequests) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequests) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
