...
func (z *jsiiProxy_ZeroTrustDlpDataTagCategory) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDlpDataTagCategory) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
