...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/workerscustomdomain/internal"
...
func (j *jsiiProxy_WorkersCustomDomain) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_WorkersCustomDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_WorkersCustomDomain) Environment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environment",
...
func (j *jsiiProxy_WorkersCustomDomain) EnvironmentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environmentInput",
...
func (j *jsiiProxy_WorkersCustomDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkersCustomDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_WorkersCustomDomain) Hostname() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostname",
...
func (j *jsiiProxy_WorkersCustomDomain) HostnameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostnameInput",
...
func (j *jsiiProxy_WorkersCustomDomain) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_WorkersCustomDomain) Node() constructs.Node {
...
func (j *jsiiProxy_WorkersCustomDomain) Service() *string {
	var returns *string
	_jsii_.Get(
		j,
		"service",
...
func (j *jsiiProxy_WorkersCustomDomain) ServiceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceInput",
...
func (j *jsiiProxy_WorkersCustomDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WorkersCustomDomain) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_WorkersCustomDomain) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func (j *jsiiProxy_WorkersCustomDomain) ZoneName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneName",
...
func NewWorkersCustomDomain(scope constructs.Construct, id *string, config *WorkersCustomDomainConfig) WorkersCustomDomain {
	...
	if err := validateNewWorkersCustomDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WorkersCustomDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.workersCustomDomain.WorkersCustomDomain",
...
func (w *jsiiProxy_WorkersCustomDomain) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WorkersCustomDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_WorkersCustomDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_WorkersCustomDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_WorkersCustomDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_WorkersCustomDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_WorkersCustomDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_WorkersCustomDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_WorkersCustomDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkersCustomDomain) MoveFromId(id *string) {
...
func (w *jsiiProxy_WorkersCustomDomain) MoveToId(id *string) {
...
func (w *jsiiProxy_WorkersCustomDomain) OverrideLogicalId(newLogicalId *string) {
...
func (w *jsiiProxy_WorkersCustomDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkersCustomDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_WorkersCustomDomain) ToString() *string {
	var returns *string
