...
func (j *jsiiProxy_LoadBalancerSessionAffinityAttributesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLoadBalancerSessionAffinityAttributesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LoadBalancerSessionAffinityAttributesOutputReference {
	_init_.Initialize()

	if err := validateNewLoadBalancerSessionAffinityAttributesOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewLoadBalancerSessionAffinityAttributesOutputReference_Override(l LoadBalancerSessionAffinityAttributesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LoadBalancerSessionAffinityAttributesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LoadBalancerSessionAffinityAttributesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LoadBalancerSessionAffinityAttributesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LoadBalancerSessionAffinityAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LoadBalancerSessionAffinityAttributesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
