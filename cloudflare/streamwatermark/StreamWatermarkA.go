...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/streamwatermark/internal"
...
func (s *jsiiProxy_StreamWatermarkA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamWatermarkA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamWatermarkA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
