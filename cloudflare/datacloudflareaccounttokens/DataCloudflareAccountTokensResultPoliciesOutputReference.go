...
func (d *jsiiProxy_DataCloudflareAccountTokensResultPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareAccountTokensResultPoliciesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
