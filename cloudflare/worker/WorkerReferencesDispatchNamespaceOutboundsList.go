...
func (j *jsiiProxy_WorkerReferencesDispatchNamespaceOutboundsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWorkerReferencesDispatchNamespaceOutboundsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WorkerReferencesDispatchNamespaceOutboundsList {
	_init_.Initialize()
...
func NewWorkerReferencesDispatchNamespaceOutboundsList_Override(w WorkerReferencesDispatchNamespaceOutboundsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkerReferencesDispatchNamespaceOutboundsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkerReferencesDispatchNamespaceOutboundsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkerReferencesDispatchNamespaceOutboundsList) Resolve(context cdktn.IResolveContext) interface{} {
