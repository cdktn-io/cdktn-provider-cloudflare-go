...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) InternalValue() interface{} {
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList)SetWrapsSet(val *bool) {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) ComputeFqn() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) Get(index *float64) ZeroTrustAccessApplicationPoliciesRequireOutputReference {
	if err := z.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ZeroTrustAccessApplicationPoliciesRequireOutputReference
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireList) ToString() *string {
	var returns *string
