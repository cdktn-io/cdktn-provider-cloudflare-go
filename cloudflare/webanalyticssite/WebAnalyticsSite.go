...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/webanalyticssite/internal"
...
type jsiiProxy_WebAnalyticsSite struct {
	internal.Type__cdktnTerraformResource
}

func (j *jsiiProxy_WebAnalyticsSite) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_WebAnalyticsSite) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_WebAnalyticsSite) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WebAnalyticsSite) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WebAnalyticsSite) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WebAnalyticsSite) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_WebAnalyticsSite) Host() *string {
	var returns *string
	_jsii_.Get(
		j,
		"host",
...
func (j *jsiiProxy_WebAnalyticsSite) HostInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostInput",
...
func (j *jsiiProxy_WebAnalyticsSite) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_WebAnalyticsSite) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WebAnalyticsSite) Node() constructs.Node {
...
func (j *jsiiProxy_WebAnalyticsSite) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WebAnalyticsSite) SiteTag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"siteTag",
...
func (j *jsiiProxy_WebAnalyticsSite) SiteToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"siteToken",
...
func (j *jsiiProxy_WebAnalyticsSite) Snippet() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snippet",
...
func (j *jsiiProxy_WebAnalyticsSite) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WebAnalyticsSite) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WebAnalyticsSite) ZoneTagInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneTagInput",
...
func NewWebAnalyticsSite(scope constructs.Construct, id *string, config *WebAnalyticsSiteConfig) WebAnalyticsSite {
	...
	if err := validateNewWebAnalyticsSiteParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_WebAnalyticsSite)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WebAnalyticsSite)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WebAnalyticsSite)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WebAnalyticsSite_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateWebAnalyticsSite_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func WebAnalyticsSite_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.webAnalyticsSite.WebAnalyticsSite",
...
func (w *jsiiProxy_WebAnalyticsSite) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WebAnalyticsSite) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAnalyticsSite) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (w *jsiiProxy_WebAnalyticsSite) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (w *jsiiProxy_WebAnalyticsSite) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (w *jsiiProxy_WebAnalyticsSite) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (w *jsiiProxy_WebAnalyticsSite) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (w *jsiiProxy_WebAnalyticsSite) GetStringAttribute(terraformAttribute *string) *string {
...
func (w *jsiiProxy_WebAnalyticsSite) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (w *jsiiProxy_WebAnalyticsSite) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WebAnalyticsSite) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WebAnalyticsSite) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WebAnalyticsSite) OverrideLogicalId(newLogicalId *string) {
...
func (w *jsiiProxy_WebAnalyticsSite) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WebAnalyticsSite) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_WebAnalyticsSite) ResetZoneTag() {
	_jsii_.InvokeVoid(
		w,
		"resetZoneTag",
		nil, // no parameters
...
func (w *jsiiProxy_WebAnalyticsSite) ToString() *string {
	var returns *string
