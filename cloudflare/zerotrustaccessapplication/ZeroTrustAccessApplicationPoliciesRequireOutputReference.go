...
type ZeroTrustAccessApplicationPoliciesRequireOutputReference interface {
	...
	LinkedAppToken() ZeroTrustAccessApplicationPoliciesRequireLinkedAppTokenOutputReference
	...
	PutLinkedAppToken(value *ZeroTrustAccessApplicationPoliciesRequireLinkedAppToken)
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) LinkedAppToken() ZeroTrustAccessApplicationPoliciesRequireLinkedAppTokenOutputReference {
	var returns ZeroTrustAccessApplicationPoliciesRequireLinkedAppTokenOutputReference
	_jsii_.Get(
		j,
		"linkedAppToken",
		&returns,
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) LinkedAppTokenInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"linkedAppTokenInput",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustAccessApplicationPoliciesRequireOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ZeroTrustAccessApplicationPoliciesRequireOutputReference {
	_init_.Initialize()
...
func NewZeroTrustAccessApplicationPoliciesRequireOutputReference_Override(z ZeroTrustAccessApplicationPoliciesRequireOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) PutLinkedAppToken(value *ZeroTrustAccessApplicationPoliciesRequireLinkedAppToken) {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) ResetLinkedAppToken() {
	_jsii_.InvokeVoid(
		z,
		"resetLinkedAppToken",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesRequireOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
