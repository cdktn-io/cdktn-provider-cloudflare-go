...
func (d *jsiiProxy_DataCloudflareMagicWanGreTunnelGreTunnelBgpStatusOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareMagicWanGreTunnelGreTunnelBgpStatusOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
