...
func (d *jsiiProxy_DataCloudflareZonesResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZonesResultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
