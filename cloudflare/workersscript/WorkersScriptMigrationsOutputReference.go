...
func (w *jsiiProxy_WorkersScriptMigrationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkersScriptMigrationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
