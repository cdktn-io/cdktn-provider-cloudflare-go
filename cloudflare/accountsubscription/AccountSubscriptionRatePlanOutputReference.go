...
func (j *jsiiProxy_AccountSubscriptionRatePlanOutputReference) ExternallyManaged() cdktf.IResolvable {
...
func (j *jsiiProxy_AccountSubscriptionRatePlanOutputReference) IsContract() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"isContract",
...
func (a *jsiiProxy_AccountSubscriptionRatePlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccountSubscriptionRatePlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
