...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/botmanagement/internal"
...
func (j *jsiiProxy_BotManagement) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BotManagement) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BotManagement) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BotManagement) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BotManagement) UsingLatestModel() cdktn.IResolvable {
...
func (j *jsiiProxy_BotManagement)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BotManagement)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BotManagement)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BotManagement_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BotManagement) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotManagement) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BotManagement) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BotManagement) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BotManagement) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
