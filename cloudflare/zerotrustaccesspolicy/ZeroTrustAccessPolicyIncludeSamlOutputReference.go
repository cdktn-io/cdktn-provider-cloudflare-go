...
func (j *jsiiProxy_ZeroTrustAccessPolicyIncludeSamlOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustAccessPolicyIncludeSamlOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ZeroTrustAccessPolicyIncludeSamlOutputReference {
	_init_.Initialize()

	if err := validateNewZeroTrustAccessPolicyIncludeSamlOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewZeroTrustAccessPolicyIncludeSamlOutputReference_Override(z ZeroTrustAccessPolicyIncludeSamlOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustAccessPolicyIncludeSamlOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyIncludeSamlOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyIncludeSamlOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (z *jsiiProxy_ZeroTrustAccessPolicyIncludeSamlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyIncludeSamlOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
