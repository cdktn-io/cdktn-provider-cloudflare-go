...
func (j *jsiiProxy_ImageVariant) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ImageVariant) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ImageVariant) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ImageVariant) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ImageVariant) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ImageVariant)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ImageVariant)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ImageVariant)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ImageVariant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_ImageVariant) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImageVariant) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_ImageVariant) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_ImageVariant) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_ImageVariant) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_ImageVariant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
