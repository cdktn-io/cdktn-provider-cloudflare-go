...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationAddressIdentifier", GoGetter: "DestinationAddressIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "destinationAddressIdentifierInput", GoGetter: "DestinationAddressIdentifierInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDestinationAddressIdentifier", GoMethod: "ResetDestinationAddressIdentifier"},
