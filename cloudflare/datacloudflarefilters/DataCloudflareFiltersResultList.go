...
func (j *jsiiProxy_DataCloudflareFiltersResultList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareFiltersResultList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareFiltersResultList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-cloudflare.dataCloudflareFilters.DataCloudflareFiltersResultList",
...
func NewDataCloudflareFiltersResultList_Override(d DataCloudflareFiltersResultList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareFiltersResultList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareFiltersResultList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareFiltersResultList) Resolve(context cdktf.IResolveContext) interface{} {
