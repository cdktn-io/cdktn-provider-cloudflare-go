...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList {
	_init_.Initialize()
...
func NewZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList_Override(z ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList) Resolve(context cdktn.IResolveContext) interface{} {
