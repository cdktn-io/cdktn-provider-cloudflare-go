...
func (j *jsiiProxy_ZeroTrustAccessGroup) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ZeroTrustAccessGroup) Exclude() ZeroTrustAccessGroupExcludeList {
	var returns ZeroTrustAccessGroupExcludeList
	_jsii_.Get(
		j,
		"exclude",
		&returns,
...
func (j *jsiiProxy_ZeroTrustAccessGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustAccessGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustAccessGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ZeroTrustAccessGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ZeroTrustAccessGroup) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ZeroTrustAccessGroup) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustAccessGroup) Require() ZeroTrustAccessGroupRequireList {
	var returns ZeroTrustAccessGroupRequireList
	_jsii_.Get(
		j,
		"require",
		&returns,
...
func (j *jsiiProxy_ZeroTrustAccessGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustAccessGroup) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewZeroTrustAccessGroup(scope constructs.Construct, id *string, config *ZeroTrustAccessGroupConfig) ZeroTrustAccessGroup {
	...
	if err := validateNewZeroTrustAccessGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (z *jsiiProxy_ZeroTrustAccessGroup) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustAccessGroup) ResetAccountId() {
	_jsii_.InvokeVoid(
		z,
		"resetAccountId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessGroup) ResetExclude() {
	_jsii_.InvokeVoid(
		z,
		"resetExclude",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessGroup) ResetRequire() {
	_jsii_.InvokeVoid(
		z,
		"resetRequire",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessGroup) ResetZoneId() {
	_jsii_.InvokeVoid(
		z,
		"resetZoneId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessGroup) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustAccessGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
