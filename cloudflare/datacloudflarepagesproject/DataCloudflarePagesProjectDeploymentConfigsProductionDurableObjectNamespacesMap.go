...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap {
	_init_.Initialize()
...
func NewDataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap_Override(d DataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionDurableObjectNamespacesMap) Resolve(context cdktf.IResolveContext) interface{} {
