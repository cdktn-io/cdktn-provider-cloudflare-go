...
func (j *jsiiProxy_DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-cloudflare.dataCloudflarePagesProjects.DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap",
...
func NewDataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap_Override(d DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePagesProjectsResultDeploymentConfigsPreviewR2BucketsMap) Resolve(context cdktf.IResolveContext) interface{} {
