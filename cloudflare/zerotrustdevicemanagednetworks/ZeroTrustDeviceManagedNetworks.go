...
func (z *jsiiProxy_ZeroTrustDeviceManagedNetworks) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceManagedNetworks) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustDeviceManagedNetworks) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
