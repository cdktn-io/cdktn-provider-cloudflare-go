...
func (d *jsiiProxy_DataCloudflareMagicTransitSiteLanStaticAddressingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareMagicTransitSiteLanStaticAddressingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
