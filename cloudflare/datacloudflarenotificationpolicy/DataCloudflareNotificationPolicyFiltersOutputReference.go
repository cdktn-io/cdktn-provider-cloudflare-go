...
func (d *jsiiProxy_DataCloudflareNotificationPolicyFiltersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareNotificationPolicyFiltersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
