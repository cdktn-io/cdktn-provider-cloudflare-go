...
func (d *jsiiProxy_DataCloudflareStreamsResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareStreamsResultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
