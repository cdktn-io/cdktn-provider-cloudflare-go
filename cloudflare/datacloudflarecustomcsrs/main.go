...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomCsrs)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareCustomCsrs.DataCloudflareCustomCsrsConfig",
		reflect.TypeOf((*DataCloudflareCustomCsrsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareCustomCsrs.DataCloudflareCustomCsrsResult",
		reflect.TypeOf((*DataCloudflareCustomCsrsResult)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareCustomCsrs.DataCloudflareCustomCsrsResultList",
		reflect.TypeOf((*DataCloudflareCustomCsrsResultList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomCsrsResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
