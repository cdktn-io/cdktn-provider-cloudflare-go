...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustDeviceSubnet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.zeroTrustDeviceSubnet.ZeroTrustDeviceSubnetCapacity",
		reflect.TypeOf((*ZeroTrustDeviceSubnetCapacity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.zeroTrustDeviceSubnet.ZeroTrustDeviceSubnetCapacityOutputReference",
		reflect.TypeOf((*ZeroTrustDeviceSubnetCapacityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ZeroTrustDeviceSubnetConfig)(nil)).Elem(),
	)
}
