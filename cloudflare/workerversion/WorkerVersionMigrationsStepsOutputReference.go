...
func (j *jsiiProxy_WorkerVersionMigrationsStepsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWorkerVersionMigrationsStepsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WorkerVersionMigrationsStepsOutputReference {
	_init_.Initialize()
...
func NewWorkerVersionMigrationsStepsOutputReference_Override(w WorkerVersionMigrationsStepsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkerVersionMigrationsStepsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
