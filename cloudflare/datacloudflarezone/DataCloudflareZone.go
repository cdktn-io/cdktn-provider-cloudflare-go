...
func (j *jsiiProxy_DataCloudflareZone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareZone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareZone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareZone) Paused() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareZone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareZone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareZone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareZone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareZone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareZone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
