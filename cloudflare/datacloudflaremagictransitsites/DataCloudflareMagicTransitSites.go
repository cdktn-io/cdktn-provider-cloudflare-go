...
func (j *jsiiProxy_DataCloudflareMagicTransitSites) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareMagicTransitSites)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareMagicTransitSites_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareMagicTransitSites) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareMagicTransitSites) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareMagicTransitSites) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareMagicTransitSites) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
