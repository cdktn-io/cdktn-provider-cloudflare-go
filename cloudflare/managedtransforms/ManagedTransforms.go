...
func (j *jsiiProxy_ManagedTransforms) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ManagedTransforms) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedTransforms) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ManagedTransforms) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ManagedTransforms) ManagedRequestHeaders() ManagedTransformsManagedRequestHeadersList {
	var returns ManagedTransformsManagedRequestHeadersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedTransforms) ManagedResponseHeaders() ManagedTransformsManagedResponseHeadersList {
	var returns ManagedTransformsManagedResponseHeadersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedTransforms) Node() constructs.Node {
...
func (j *jsiiProxy_ManagedTransforms) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ManagedTransforms) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ManagedTransforms) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewManagedTransforms(scope constructs.Construct, id *string, config *ManagedTransformsConfig) ManagedTransforms {
	...
	if err := validateNewManagedTransformsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ManagedTransforms_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.managedTransforms.ManagedTransforms",
...
func (m *jsiiProxy_ManagedTransforms) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_ManagedTransforms) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (m *jsiiProxy_ManagedTransforms) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (m *jsiiProxy_ManagedTransforms) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (m *jsiiProxy_ManagedTransforms) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (m *jsiiProxy_ManagedTransforms) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (m *jsiiProxy_ManagedTransforms) GetStringAttribute(terraformAttribute *string) *string {
...
func (m *jsiiProxy_ManagedTransforms) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (m *jsiiProxy_ManagedTransforms) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_ManagedTransforms) MoveFromId(id *string) {
...
func (m *jsiiProxy_ManagedTransforms) MoveToId(id *string) {
...
func (m *jsiiProxy_ManagedTransforms) OverrideLogicalId(newLogicalId *string) {
...
func (m *jsiiProxy_ManagedTransforms) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_ManagedTransforms) ResetManagedRequestHeaders() {
	_jsii_.InvokeVoid(
		m,
		"resetManagedRequestHeaders",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedTransforms) ResetManagedResponseHeaders() {
	_jsii_.InvokeVoid(
		m,
		"resetManagedResponseHeaders",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedTransforms) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedTransforms) ToString() *string {
	var returns *string
...
func (m *jsiiProxy_ManagedTransforms) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
