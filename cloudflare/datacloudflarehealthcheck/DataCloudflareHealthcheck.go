...
type DataCloudflareHealthcheck interface {
	...
	HttpConfig() DataCloudflareHealthcheckHttpConfigOutputReference
	Id() *string
	Interval() *float64
	// Experimental.
...
func (j *jsiiProxy_DataCloudflareHealthcheck) CheckRegions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"checkRegions",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) ConsecutiveFails() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"consecutiveFails",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) ConsecutiveSuccesses() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareHealthcheck) CreatedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdOn",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) FailureReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"failureReason",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) HealthcheckId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"healthcheckId",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) HealthcheckIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"healthcheckIdInput",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) HttpConfig() DataCloudflareHealthcheckHttpConfigOutputReference {
	var returns DataCloudflareHealthcheckHttpConfigOutputReference
	_jsii_.Get(
		j,
		"httpConfig",
		&returns,
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Interval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"interval",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) ModifiedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modifiedOn",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Retries() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"retries",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) TcpConfig() DataCloudflareHealthcheckTcpConfigOutputReference {
	var returns DataCloudflareHealthcheckTcpConfigOutputReference
	_jsii_.Get(
		j,
		"tcpConfig",
		&returns,
...
func (j *jsiiProxy_DataCloudflareHealthcheck) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Timeout() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"timeout",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DataCloudflareHealthcheck) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewDataCloudflareHealthcheck(scope constructs.Construct, id *string, config *DataCloudflareHealthcheckConfig) DataCloudflareHealthcheck {
	...
	if err := validateNewDataCloudflareHealthcheckParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareHealthcheck_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareHealthcheck.DataCloudflareHealthcheck",
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareHealthcheck) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareHealthcheck) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareHealthcheck) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
