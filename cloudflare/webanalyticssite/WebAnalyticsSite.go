...
func (j *jsiiProxy_WebAnalyticsSite) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_WebAnalyticsSite) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WebAnalyticsSite) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.14.0/docs/resources/web_analytics_site cloudflare_web_analytics_site} Resource.
...
func WebAnalyticsSite_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WebAnalyticsSite) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebAnalyticsSite) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
