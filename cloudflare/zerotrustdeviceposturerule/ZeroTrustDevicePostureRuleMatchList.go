...
func (j *jsiiProxy_ZeroTrustDevicePostureRuleMatchList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustDevicePostureRuleMatchList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDevicePostureRuleMatchList {
	_init_.Initialize()
...
func NewZeroTrustDevicePostureRuleMatchList_Override(z ZeroTrustDevicePostureRuleMatchList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDevicePostureRuleMatchList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDevicePostureRuleMatchList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDevicePostureRuleMatchList) Resolve(context cdktn.IResolveContext) interface{} {
