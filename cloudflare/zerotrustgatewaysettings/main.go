...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledDownloadPhase", GoMethod: "ResetEnabledDownloadPhase"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledUploadPhase", GoMethod: "ResetEnabledUploadPhase"},
			_jsii_.MemberMethod{JsiiMethod: "resetFailClosed", GoMethod: "ResetFailClosed"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetInspectionMode", GoMethod: "ResetInspectionMode"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "nonIdentityEnabled", GoGetter: "NonIdentityEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "nonIdentityEnabledInput", GoGetter: "NonIdentityEnabledInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetNonIdentityEnabled", GoMethod: "ResetNonIdentityEnabled"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "browserIsolation", GoGetter: "BrowserIsolation"},
			_jsii_.MemberProperty{JsiiProperty: "browserIsolationInput", GoGetter: "BrowserIsolationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "protocolDetection", GoGetter: "ProtocolDetection"},
