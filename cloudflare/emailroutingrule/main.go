...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ownerWorkerTag", GoGetter: "OwnerWorkerTag"},
			_jsii_.MemberProperty{JsiiProperty: "ownerWorkerTagInput", GoGetter: "OwnerWorkerTagInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOwnerWorkerTag", GoMethod: "ResetOwnerWorkerTag"},
