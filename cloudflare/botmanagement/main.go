...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "contentBotsProtectionInput", GoGetter: "ContentBotsProtectionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetContentBotsProtection", GoMethod: "ResetContentBotsProtection"},
