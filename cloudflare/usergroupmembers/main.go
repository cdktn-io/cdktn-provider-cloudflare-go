...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UserGroupMembers)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*UserGroupMembersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.userGroupMembers.UserGroupMembersMembers",
		reflect.TypeOf((*UserGroupMembersMembers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.userGroupMembers.UserGroupMembersMembersList",
		reflect.TypeOf((*UserGroupMembersMembersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UserGroupMembersMembersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
