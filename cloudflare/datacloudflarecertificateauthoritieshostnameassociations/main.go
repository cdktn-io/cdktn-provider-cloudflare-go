...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCertificateAuthoritiesHostnameAssociations)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareCertificateAuthoritiesHostnameAssociationsConfig)(nil)).Elem(),
	)
}
