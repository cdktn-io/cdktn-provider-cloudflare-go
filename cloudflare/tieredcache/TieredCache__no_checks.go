...
func (t *jsiiProxy_TieredCache) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (t *jsiiProxy_TieredCache) validateImportFromParameters(id *string) error {
	return nil
}
...
func validateTieredCache_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
