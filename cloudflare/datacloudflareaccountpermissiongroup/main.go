...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "permissionGroupId", GoGetter: "PermissionGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "permissionGroupIdInput", GoGetter: "PermissionGroupIdInput"},
