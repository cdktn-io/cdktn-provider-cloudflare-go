...
func (r *jsiiProxy_RateLimit) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RateLimit) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RateLimit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
