...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustaccessservicetoken/internal"
...
func (z *jsiiProxy_ZeroTrustAccessServiceToken) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustAccessServiceToken) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustAccessServiceToken) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
