...
type DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference interface {
	...
	LinkedAppToken() DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeLinkedAppTokenOutputReference
	LoginMethod() DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeLoginMethodOutputReference
	Oidc() DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOidcOutputReference
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) LinkedAppToken() DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeLinkedAppTokenOutputReference {
	var returns DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeLinkedAppTokenOutputReference
	_jsii_.Get(
		j,
		"linkedAppToken",
		&returns,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) Oidc() DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOidcOutputReference {
	var returns DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOidcOutputReference
	_jsii_.Get(
		j,
		"oidc",
		&returns,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference_Override(d DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationsResultPoliciesExcludeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
