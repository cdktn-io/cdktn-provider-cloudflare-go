...
func (j *jsiiProxy_DataCloudflareAccountMembersResultRolesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareAccountMembersResultRolesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareAccountMembersResultRolesList {
	_init_.Initialize()
...
func NewDataCloudflareAccountMembersResultRolesList_Override(d DataCloudflareAccountMembersResultRolesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareAccountMembersResultRolesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareAccountMembersResultRolesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareAccountMembersResultRolesList) Resolve(context cdktf.IResolveContext) interface{} {
