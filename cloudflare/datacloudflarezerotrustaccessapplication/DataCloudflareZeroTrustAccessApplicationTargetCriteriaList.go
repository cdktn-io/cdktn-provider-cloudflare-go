...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationTargetCriteriaList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessApplicationTargetCriteriaList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustAccessApplicationTargetCriteriaList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessApplicationTargetCriteriaList_Override(d DataCloudflareZeroTrustAccessApplicationTargetCriteriaList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplicationTargetCriteriaList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationTargetCriteriaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplicationTargetCriteriaList) Resolve(context cdktf.IResolveContext) interface{} {
