...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/useragentblockingrule/internal"
...
func (u *jsiiProxy_UserAgentBlockingRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UserAgentBlockingRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (u *jsiiProxy_UserAgentBlockingRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
