...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap {
	_init_.Initialize()
...
func NewDataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap_Override(d DataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsPreviewMtlsCertificatesMap) Resolve(context cdktf.IResolveContext) interface{} {
