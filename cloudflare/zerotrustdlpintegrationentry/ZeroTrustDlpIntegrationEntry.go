...
func (j *jsiiProxy_ZeroTrustDlpIntegrationEntry) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustDlpIntegrationEntry) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustDlpIntegrationEntry) Provider() cdktf.TerraformProvider {
...
func ZeroTrustDlpIntegrationEntry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustDlpIntegrationEntry) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDlpIntegrationEntry) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustDlpIntegrationEntry) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
