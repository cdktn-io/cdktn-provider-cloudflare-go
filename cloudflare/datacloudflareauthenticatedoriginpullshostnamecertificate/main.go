...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareAuthenticatedOriginPullsHostnameCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareAuthenticatedOriginPullsHostnameCertificateConfig)(nil)).Elem(),
	)
}
