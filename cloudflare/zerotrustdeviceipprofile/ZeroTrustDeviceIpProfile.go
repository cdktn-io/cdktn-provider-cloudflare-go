...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustdeviceipprofile/internal"
...
func (z *jsiiProxy_ZeroTrustDeviceIpProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceIpProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
