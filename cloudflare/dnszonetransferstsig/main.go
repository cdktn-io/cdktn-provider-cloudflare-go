...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DnsZoneTransfersTsig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "algoInput", GoGetter: "AlgoInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DnsZoneTransfersTsigConfig)(nil)).Elem(),
	)
}
