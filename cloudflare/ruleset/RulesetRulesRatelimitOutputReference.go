...
func NewRulesetRulesRatelimitOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) RulesetRulesRatelimitOutputReference {
	_init_.Initialize()
...
func NewRulesetRulesRatelimitOutputReference_Override(r RulesetRulesRatelimitOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
