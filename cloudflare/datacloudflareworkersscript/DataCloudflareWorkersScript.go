...
func (j *jsiiProxy_DataCloudflareWorkersScript) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataCloudflareWorkersScript) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareWorkersScript) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareWorkersScript) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareWorkersScript) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareWorkersScript) ScriptName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scriptName",
...
func (j *jsiiProxy_DataCloudflareWorkersScript) ScriptNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scriptNameInput",
...
func (j *jsiiProxy_DataCloudflareWorkersScript) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/workers_script cloudflare_workers_script} Data Source.
func NewDataCloudflareWorkersScript(scope constructs.Construct, id *string, config *DataCloudflareWorkersScriptConfig) DataCloudflareWorkersScript {
	...
	if err := validateNewDataCloudflareWorkersScriptParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareWorkersScript_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareWorkersScript.DataCloudflareWorkersScript",
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareWorkersScript) ToString() *string {
	var returns *string
