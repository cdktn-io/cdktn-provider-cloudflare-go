...
func (s *jsiiProxy_Stream) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_Stream) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_Stream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
