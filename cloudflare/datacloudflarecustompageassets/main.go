...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomPageAssets)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomPageAssetsResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
