...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/hostnametlssetting/internal"
...
func (h *jsiiProxy_HostnameTlsSetting) AddMoveTarget(moveTarget *string) {
...
func (h *jsiiProxy_HostnameTlsSetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (h *jsiiProxy_HostnameTlsSetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HostnameTlsSetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
