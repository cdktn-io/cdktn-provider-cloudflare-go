...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "neverRequireSignedUrls", GoGetter: "NeverRequireSignedUrls"},
			_jsii_.MemberProperty{JsiiProperty: "neverRequireSignedUrlsInput", GoGetter: "NeverRequireSignedUrlsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNeverRequireSignedUrls", GoMethod: "ResetNeverRequireSignedUrls"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fit", GoGetter: "Fit"},
			_jsii_.MemberProperty{JsiiProperty: "fitInput", GoGetter: "FitInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
