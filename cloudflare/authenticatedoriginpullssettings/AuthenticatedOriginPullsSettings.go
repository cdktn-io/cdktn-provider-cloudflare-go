...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/authenticatedoriginpullssettings/internal"
...
func (j *jsiiProxy_AuthenticatedOriginPullsSettings) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AuthenticatedOriginPullsSettings) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AuthenticatedOriginPullsSettings) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AuthenticatedOriginPullsSettings) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AuthenticatedOriginPullsSettings) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func AuthenticatedOriginPullsSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AuthenticatedOriginPullsSettings) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AuthenticatedOriginPullsSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AuthenticatedOriginPullsSettings) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
