...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList) Get(index *float64) DataCloudflareZeroTrustDlpCustomProfileEntriesOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataCloudflareZeroTrustDlpCustomProfileEntriesOutputReference
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpCustomProfileEntriesList) ToString() *string {
	var returns *string
