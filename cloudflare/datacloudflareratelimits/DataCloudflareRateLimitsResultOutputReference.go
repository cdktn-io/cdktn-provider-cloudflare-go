...
func (d *jsiiProxy_DataCloudflareRateLimitsResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareRateLimitsResultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
