...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "cookieAttributes", GoGetter: "CookieAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "cookieSuffix", GoGetter: "CookieSuffix"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enabledOriginCommands", GoGetter: "EnabledOriginCommands"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "nextEventPrequeueStartTime", GoGetter: "NextEventPrequeueStartTime"},
			_jsii_.MemberProperty{JsiiProperty: "nextEventStartTime", GoGetter: "NextEventStartTime"},
			_jsii_.MemberProperty{JsiiProperty: "path", GoGetter: "Path"},
