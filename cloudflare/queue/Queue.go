...
func (q *jsiiProxy_Queue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_Queue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
