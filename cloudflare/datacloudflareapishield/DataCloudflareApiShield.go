...
func (j *jsiiProxy_DataCloudflareApiShield) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareApiShield) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareApiShield) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DataCloudflareApiShield_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareApiShield) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareApiShield) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
