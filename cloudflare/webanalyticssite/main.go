...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lite", GoGetter: "Lite"},
			_jsii_.MemberProperty{JsiiProperty: "liteInput", GoGetter: "LiteInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoInstall", GoMethod: "ResetAutoInstall"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabled", GoMethod: "ResetEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetHost", GoMethod: "ResetHost"},
			_jsii_.MemberMethod{JsiiMethod: "resetLite", GoMethod: "ResetLite"},
