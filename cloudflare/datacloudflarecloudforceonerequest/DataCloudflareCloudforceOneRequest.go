...
type jsiiProxy_DataCloudflareCloudforceOneRequest struct {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Completed() *string {
	var returns *string
	_jsii_.Get(
		j,
		"completed",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Content() *string {
	var returns *string
	_jsii_.Get(
		j,
		"content",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Created() *string {
	var returns *string
	_jsii_.Get(
		j,
		"created",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) MessageTokens() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"messageTokens",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Priority() *string {
	var returns *string
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) ReadableId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readableId",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Request() *string {
	var returns *string
	_jsii_.Get(
		j,
		"request",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Summary() *string {
	var returns *string
	_jsii_.Get(
		j,
		"summary",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Tlp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tlp",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Tokens() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"tokens",
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest) Updated() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updated",
...
func NewDataCloudflareCloudforceOneRequest(scope constructs.Construct, id *string, config *DataCloudflareCloudforceOneRequestConfig) DataCloudflareCloudforceOneRequest {
	...
	if err := validateNewDataCloudflareCloudforceOneRequestParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequest)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareCloudforceOneRequest_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareCloudforceOneRequest_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataCloudflareCloudforceOneRequest_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareCloudforceOneRequest.DataCloudflareCloudforceOneRequest",
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequest) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
