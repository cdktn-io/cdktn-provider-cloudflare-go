...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "interruptWindowDaysOfWeek", GoGetter: "InterruptWindowDaysOfWeek"},
			_jsii_.MemberProperty{JsiiProperty: "interruptWindowDurationHours", GoGetter: "InterruptWindowDurationHours"},
			_jsii_.MemberProperty{JsiiProperty: "interruptWindowEmbargoDates", GoGetter: "InterruptWindowEmbargoDates"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilter",
		reflect.TypeOf((*DataCloudflareMagicTransitConnectorFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilterOutputReference",
		reflect.TypeOf((*DataCloudflareMagicTransitConnectorFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
