...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zonesubscription/internal"
...
type ZoneSubscription interface {
	...
	PutRatePlan(value *ZoneSubscriptionRatePlan)
...
func (j *jsiiProxy_ZoneSubscription) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZoneSubscription) Frequency() *string {
	var returns *string
	_jsii_.Get(
		j,
		"frequency",
...
func (j *jsiiProxy_ZoneSubscription) FrequencyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"frequencyInput",
...
func (j *jsiiProxy_ZoneSubscription) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZoneSubscription) Node() constructs.Node {
...
func (j *jsiiProxy_ZoneSubscription) RatePlan() ZoneSubscriptionRatePlanOutputReference {
	var returns ZoneSubscriptionRatePlanOutputReference
	_jsii_.Get(
		j,
		"ratePlan",
		&returns,
...
func (j *jsiiProxy_ZoneSubscription) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewZoneSubscription(scope constructs.Construct, id *string, config *ZoneSubscriptionConfig) ZoneSubscription {
	...
	if err := validateNewZoneSubscriptionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ZoneSubscription_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.zoneSubscription.ZoneSubscription",
...
func (z *jsiiProxy_ZoneSubscription) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZoneSubscription) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZoneSubscription) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZoneSubscription) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZoneSubscription) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZoneSubscription) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZoneSubscription) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZoneSubscription) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZoneSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZoneSubscription) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZoneSubscription) MoveToId(id *string) {
...
func (z *jsiiProxy_ZoneSubscription) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZoneSubscription) PutRatePlan(value *ZoneSubscriptionRatePlan) {
	if err := z.validatePutRatePlanParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		z,
...
func (z *jsiiProxy_ZoneSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZoneSubscription) ResetFrequency() {
	_jsii_.InvokeVoid(
		z,
		"resetFrequency",
		nil, // no parameters
...
func (z *jsiiProxy_ZoneSubscription) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZoneSubscription) ResetRatePlan() {
	_jsii_.InvokeVoid(
		z,
		"resetRatePlan",
		nil, // no parameters
...
func (z *jsiiProxy_ZoneSubscription) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZoneSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
