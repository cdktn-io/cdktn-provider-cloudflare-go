...
func (d *jsiiProxy_DataCloudflareStreamsResultWatermarkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareStreamsResultWatermarkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
