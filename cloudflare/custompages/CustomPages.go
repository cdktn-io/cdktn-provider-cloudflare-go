...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/custompages/internal"
...
func (c *jsiiProxy_CustomPages) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomPages) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomPages) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
