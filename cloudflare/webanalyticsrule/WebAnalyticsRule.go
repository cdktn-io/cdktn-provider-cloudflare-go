...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/webanalyticsrule/internal"
...
func (j *jsiiProxy_WebAnalyticsRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_WebAnalyticsRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WebAnalyticsRule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WebAnalyticsRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WebAnalyticsRule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func WebAnalyticsRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WebAnalyticsRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebAnalyticsRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WebAnalyticsRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
