...
func (r *jsiiProxy_R2BucketLockRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_R2BucketLockRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
