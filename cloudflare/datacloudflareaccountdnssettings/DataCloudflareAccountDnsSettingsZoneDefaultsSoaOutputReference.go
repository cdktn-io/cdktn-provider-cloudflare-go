...
func (d *jsiiProxy_DataCloudflareAccountDnsSettingsZoneDefaultsSoaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareAccountDnsSettingsZoneDefaultsSoaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
