...
func (z *jsiiProxy_ZeroTrustAccessPolicyRequireAuthMethodOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyRequireAuthMethodOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
