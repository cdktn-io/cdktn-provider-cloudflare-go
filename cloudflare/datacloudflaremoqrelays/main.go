...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareMoqRelays)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareMoqRelays.DataCloudflareMoqRelaysConfig",
		reflect.TypeOf((*DataCloudflareMoqRelaysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareMoqRelays.DataCloudflareMoqRelaysResult",
		reflect.TypeOf((*DataCloudflareMoqRelaysResult)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareMoqRelays.DataCloudflareMoqRelaysResultList",
		reflect.TypeOf((*DataCloudflareMoqRelaysResultList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareMoqRelaysResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
