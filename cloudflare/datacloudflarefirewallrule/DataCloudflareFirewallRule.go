...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarefirewallrule/internal"
...
func (j *jsiiProxy_DataCloudflareFirewallRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Products() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"products",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) RuleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleId",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) RuleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleIdInput",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareFirewallRule) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DataCloudflareFirewallRule) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewDataCloudflareFirewallRule(scope constructs.Construct, id *string, config *DataCloudflareFirewallRuleConfig) DataCloudflareFirewallRule {
	...
	if err := validateNewDataCloudflareFirewallRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareFirewallRule_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareFirewallRule.DataCloudflareFirewallRule",
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareFirewallRule) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareFirewallRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
