...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWarpRoutingEnabled", GoMethod: "ResetWarpRoutingEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "warpRoutingEnabledInput", GoGetter: "WarpRoutingEnabledInput"},
		},
		func() interface{} {
