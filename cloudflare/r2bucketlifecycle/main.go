...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "deleteObjectsTransition", GoGetter: "DeleteObjectsTransition"},
			_jsii_.MemberProperty{JsiiProperty: "deleteObjectsTransitionInput", GoGetter: "DeleteObjectsTransitionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAbortMultipartUploadsTransition", GoMethod: "PutAbortMultipartUploadsTransition"},
			_jsii_.MemberMethod{JsiiMethod: "putConditions", GoMethod: "PutConditions"},
			_jsii_.MemberMethod{JsiiMethod: "putDeleteObjectsTransition", GoMethod: "PutDeleteObjectsTransition"},
			_jsii_.MemberMethod{JsiiMethod: "putStorageClassTransitions", GoMethod: "PutStorageClassTransitions"},
			_jsii_.MemberMethod{JsiiMethod: "resetAbortMultipartUploadsTransition", GoMethod: "ResetAbortMultipartUploadsTransition"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeleteObjectsTransition", GoMethod: "ResetDeleteObjectsTransition"},
			_jsii_.MemberMethod{JsiiMethod: "resetStorageClassTransitions", GoMethod: "ResetStorageClassTransitions"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "storageClassTransitions", GoGetter: "StorageClassTransitions"},
			_jsii_.MemberProperty{JsiiProperty: "storageClassTransitionsInput", GoGetter: "StorageClassTransitionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
