...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustNetworkHostnameRoute)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.zeroTrustNetworkHostnameRoute.ZeroTrustNetworkHostnameRouteConfig",
		reflect.TypeOf((*ZeroTrustNetworkHostnameRouteConfig)(nil)).Elem(),
	)
}
