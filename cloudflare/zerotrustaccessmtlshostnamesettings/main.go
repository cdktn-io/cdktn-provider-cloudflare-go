...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clientCertificateForwarding", GoGetter: "ClientCertificateForwarding"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clientCertificateForwarding", GoGetter: "ClientCertificateForwarding"},
			_jsii_.MemberProperty{JsiiProperty: "clientCertificateForwardingInput", GoGetter: "ClientCertificateForwardingInput"},
