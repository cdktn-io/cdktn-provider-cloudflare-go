...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustGatewayProxyEndpoint)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.zeroTrustGatewayProxyEndpoint.ZeroTrustGatewayProxyEndpointConfig",
		reflect.TypeOf((*ZeroTrustGatewayProxyEndpointConfig)(nil)).Elem(),
	)
}
