...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultSampling", GoGetter: "DefaultSampling"},
			_jsii_.MemberProperty{JsiiProperty: "defaultSamplingInput", GoGetter: "DefaultSamplingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putWarpDevices", GoMethod: "PutWarpDevices"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultSampling", GoMethod: "ResetDefaultSampling"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRouterIps", GoMethod: "ResetRouterIps"},
			_jsii_.MemberMethod{JsiiMethod: "resetWarpDevices", GoMethod: "ResetWarpDevices"},
			_jsii_.MemberProperty{JsiiProperty: "routerIps", GoGetter: "RouterIps"},
			_jsii_.MemberProperty{JsiiProperty: "routerIpsInput", GoGetter: "RouterIpsInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "routerIp", GoGetter: "RouterIp"},
			_jsii_.MemberProperty{JsiiProperty: "routerIpInput", GoGetter: "RouterIpInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
