...
func (j *jsiiProxy_Image) validateSetAccountIdParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Image) validateSetMetadataParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Image) validateSetUrlParameters(val *string) error {
	return nil
}
