...
func (d *jsiiProxy_DataCloudflareAccountMemberRolesPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareAccountMemberRolesPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
