...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZeroTrustDeviceCustomProfileLocalDomainFallback_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileLocalDomainFallback) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
