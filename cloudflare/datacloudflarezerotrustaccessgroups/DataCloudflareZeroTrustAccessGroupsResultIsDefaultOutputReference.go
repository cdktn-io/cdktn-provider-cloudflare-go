...
type DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference interface {
	...
	CloudflareAccountMember() DataCloudflareZeroTrustAccessGroupsResultIsDefaultCloudflareAccountMemberOutputReference
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference) CloudflareAccountMember() DataCloudflareZeroTrustAccessGroupsResultIsDefaultCloudflareAccountMemberOutputReference {
	var returns DataCloudflareZeroTrustAccessGroupsResultIsDefaultCloudflareAccountMemberOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference_Override(d DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultIsDefaultOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
