...
func (j *jsiiProxy_DataCloudflareZoneLockdowns) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareZoneLockdowns)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareZoneLockdowns_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareZoneLockdowns) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZoneLockdowns) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZoneLockdowns) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareZoneLockdowns) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
