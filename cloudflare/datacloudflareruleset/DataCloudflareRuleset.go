...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/ruleset cloudflare_ruleset}.
...
func (j *jsiiProxy_DataCloudflareRuleset) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataCloudflareRuleset) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareRuleset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataCloudflareRuleset) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareRuleset) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareRuleset) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareRuleset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataCloudflareRuleset) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareRuleset) Phase() *string {
	var returns *string
	_jsii_.Get(
		j,
		"phase",
...
func (j *jsiiProxy_DataCloudflareRuleset) Rules() DataCloudflareRulesetRulesList {
	var returns DataCloudflareRulesetRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_DataCloudflareRuleset) RulesetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rulesetId",
...
func (j *jsiiProxy_DataCloudflareRuleset) RulesetIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rulesetIdInput",
...
func (j *jsiiProxy_DataCloudflareRuleset) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareRuleset) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/ruleset cloudflare_ruleset} Data Source.
func NewDataCloudflareRuleset(scope constructs.Construct, id *string, config *DataCloudflareRulesetConfig) DataCloudflareRuleset {
	...
	if err := validateNewDataCloudflareRulesetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareRuleset_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareRuleset.DataCloudflareRuleset",
...
func (d *jsiiProxy_DataCloudflareRuleset) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareRuleset) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareRuleset) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareRuleset) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareRuleset) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareRuleset) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareRuleset) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareRuleset) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareRuleset) ResetAccountId() {
	_jsii_.InvokeVoid(
		d,
		"resetAccountId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareRuleset) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareRuleset) ResetRulesetId() {
	_jsii_.InvokeVoid(
		d,
		"resetRulesetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareRuleset) ResetZoneId() {
	_jsii_.InvokeVoid(
		d,
		"resetZoneId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareRuleset) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareRuleset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
