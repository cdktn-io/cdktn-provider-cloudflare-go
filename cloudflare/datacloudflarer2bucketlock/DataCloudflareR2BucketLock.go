...
func (j *jsiiProxy_DataCloudflareR2BucketLock) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) BucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketName",
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) BucketNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketNameInput",
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) Rules() DataCloudflareR2BucketLockRulesList {
	var returns DataCloudflareR2BucketLockRulesList
	_jsii_.Get(
		j,
		"rules",
		&returns,
...
func (j *jsiiProxy_DataCloudflareR2BucketLock) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareR2BucketLock(scope constructs.Construct, id *string, config *DataCloudflareR2BucketLockConfig) DataCloudflareR2BucketLock {
	...
	if err := validateNewDataCloudflareR2BucketLockParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareR2BucketLock_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareR2BucketLock.DataCloudflareR2BucketLock",
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareR2BucketLock) ToString() *string {
	var returns *string
