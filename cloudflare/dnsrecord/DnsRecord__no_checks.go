...
func (d *jsiiProxy_DnsRecord) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}
...
func (d *jsiiProxy_DnsRecord) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}
