...
func (j *jsiiProxy_DataCloudflareSecretsStoreSecrets) Scopes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"scopes",
...
func (j *jsiiProxy_DataCloudflareSecretsStoreSecrets) ScopesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"scopesInput",
...
func (j *jsiiProxy_DataCloudflareSecretsStoreSecrets)SetScopes(val *[]*string) {
...
func (d *jsiiProxy_DataCloudflareSecretsStoreSecrets) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
