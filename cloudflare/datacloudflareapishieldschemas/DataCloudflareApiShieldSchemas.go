...
func (j *jsiiProxy_DataCloudflareApiShieldSchemas) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareApiShieldSchemas) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareApiShieldSchemas) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareApiShieldSchemas) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareApiShieldSchemas) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.13.0/docs/data-sources/api_shield_schemas cloudflare_api_shield_schemas} Data Source.
...
func DataCloudflareApiShieldSchemas_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareApiShieldSchemas) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareApiShieldSchemas) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
