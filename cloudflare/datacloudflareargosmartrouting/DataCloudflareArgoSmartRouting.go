...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflareargosmartrouting/internal"
...
func (j *jsiiProxy_DataCloudflareArgoSmartRouting) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareArgoSmartRouting) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareArgoSmartRouting) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DataCloudflareArgoSmartRouting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareArgoSmartRouting) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareArgoSmartRouting) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
