...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) Host() *string {
	var returns *string
	_jsii_.Get(
		j,
		"host",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference)SetTerraformAttribute(val *string) {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) ComputeFqn() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) ResetAddress() {
	_jsii_.InvokeVoid(
		z,
		"resetAddress",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		z,
		"resetDescription",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileIncludeOutputReference) ToString() *string {
	var returns *string
