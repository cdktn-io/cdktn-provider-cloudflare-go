...
type DataCloudflareZeroTrustAccessApplication interface {
	...
	LogoUrl() *string
	MfaConfig() DataCloudflareZeroTrustAccessApplicationMfaConfigOutputReference
	Name() *string
	// The tree node.
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) AllowAuthenticateViaWarp() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) AllowIframe() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"allowIframe",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) AppLauncherVisible() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"appLauncherVisible",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) AutoRedirectToIdentity() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) EnableBindingCookie() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"enableBindingCookie",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) HttpOnlyCookieAttribute() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) MfaConfig() DataCloudflareZeroTrustAccessApplicationMfaConfigOutputReference {
	var returns DataCloudflareZeroTrustAccessApplicationMfaConfigOutputReference
	_jsii_.Get(
		j,
		"mfaConfig",
		&returns,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) OptionsPreflightBypass() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) PathCookieAttribute() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"pathCookieAttribute",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) ServiceAuth401Redirect() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) SkipAppLauncherLoginPage() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) SkipInterstitial() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"skipInterstitial",
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareZeroTrustAccessApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
