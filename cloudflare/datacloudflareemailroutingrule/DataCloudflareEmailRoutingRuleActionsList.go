...
func (j *jsiiProxy_DataCloudflareEmailRoutingRuleActionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflareEmailRoutingRuleActionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareEmailRoutingRuleActionsList {
	_init_.Initialize()
...
func NewDataCloudflareEmailRoutingRuleActionsList_Override(d DataCloudflareEmailRoutingRuleActionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareEmailRoutingRuleActionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingRuleActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingRuleActionsList) Resolve(context cdktf.IResolveContext) interface{} {
