...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList) InternalValue() interface{} {
...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ZeroTrustDnsLocationNetworksList)SetWrapsSet(val *bool) {
...
func (z *jsiiProxy_ZeroTrustDnsLocationNetworksList) ComputeFqn() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustDnsLocationNetworksList) Get(index *float64) ZeroTrustDnsLocationNetworksOutputReference {
	if err := z.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ZeroTrustDnsLocationNetworksOutputReference
...
func (z *jsiiProxy_ZeroTrustDnsLocationNetworksList) ToString() *string {
	var returns *string
