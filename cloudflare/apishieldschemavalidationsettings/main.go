...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ApiShieldSchemaValidationSettings)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetValidationOverrideMitigationAction", GoMethod: "ResetValidationOverrideMitigationAction"},
			...
			_jsii_.MemberProperty{JsiiProperty: "validationDefaultMitigationAction", GoGetter: "ValidationDefaultMitigationAction"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ApiShieldSchemaValidationSettingsConfig)(nil)).Elem(),
	)
}
