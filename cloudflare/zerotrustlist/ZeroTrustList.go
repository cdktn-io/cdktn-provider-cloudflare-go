...
func (z *jsiiProxy_ZeroTrustList) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustList) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
