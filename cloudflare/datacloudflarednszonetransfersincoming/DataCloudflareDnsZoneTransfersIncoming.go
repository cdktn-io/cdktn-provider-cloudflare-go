...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/datacloudflarednszonetransfersincoming/internal"
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/dns_zone_transfers_incoming cloudflare_dns_zone_transfers_incoming} Data Source.
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareDnsZoneTransfersIncoming_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersIncoming) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
