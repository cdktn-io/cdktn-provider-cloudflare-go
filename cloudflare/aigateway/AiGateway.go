...
func (a *jsiiProxy_AiGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AiGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
