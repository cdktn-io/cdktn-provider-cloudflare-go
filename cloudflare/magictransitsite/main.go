...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecondaryConnectorId", GoMethod: "ResetSecondaryConnectorId"},
			_jsii_.MemberProperty{JsiiProperty: "secondaryConnectorId", GoGetter: "SecondaryConnectorId"},
			_jsii_.MemberProperty{JsiiProperty: "secondaryConnectorIdInput", GoGetter: "SecondaryConnectorIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lon", GoGetter: "Lon"},
			_jsii_.MemberProperty{JsiiProperty: "lonInput", GoGetter: "LonInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetLat", GoMethod: "ResetLat"},
			_jsii_.MemberMethod{JsiiMethod: "resetLon", GoMethod: "ResetLon"},
