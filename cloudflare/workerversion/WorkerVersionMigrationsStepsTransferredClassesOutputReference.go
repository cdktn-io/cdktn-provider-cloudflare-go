...
func (j *jsiiProxy_WorkerVersionMigrationsStepsTransferredClassesOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewWorkerVersionMigrationsStepsTransferredClassesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WorkerVersionMigrationsStepsTransferredClassesOutputReference {
	_init_.Initialize()
...
func NewWorkerVersionMigrationsStepsTransferredClassesOutputReference_Override(w WorkerVersionMigrationsStepsTransferredClassesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkerVersionMigrationsStepsTransferredClassesOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsTransferredClassesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsTransferredClassesOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsTransferredClassesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkerVersionMigrationsStepsTransferredClassesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
