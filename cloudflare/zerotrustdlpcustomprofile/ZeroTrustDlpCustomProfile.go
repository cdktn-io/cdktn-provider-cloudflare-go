...
func (z *jsiiProxy_ZeroTrustDlpCustomProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDlpCustomProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustDlpCustomProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
