...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CertificatePackDcvDelegationRecords)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.certificatePack.CertificatePackDcvDelegationRecordsList",
		reflect.TypeOf((*CertificatePackDcvDelegationRecordsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CertificatePackDcvDelegationRecordsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
