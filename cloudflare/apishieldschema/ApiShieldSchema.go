...
func (j *jsiiProxy_ApiShieldSchema) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApiShieldSchema) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApiShieldSchema) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApiShieldSchema) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ApiShieldSchema)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApiShieldSchema)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApiShieldSchema)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApiShieldSchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateApiShieldSchema_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiShieldSchema) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiShieldSchema) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiShieldSchema) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApiShieldSchema) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApiShieldSchema) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiShieldSchema) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiShieldSchema) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiShieldSchema) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
