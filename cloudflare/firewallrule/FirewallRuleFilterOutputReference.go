...
func (j *jsiiProxy_FirewallRuleFilterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFirewallRuleFilterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FirewallRuleFilterOutputReference {
	_init_.Initialize()
...
func NewFirewallRuleFilterOutputReference_Override(f FirewallRuleFilterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FirewallRuleFilterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FirewallRuleFilterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallRuleFilterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FirewallRuleFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FirewallRuleFilterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
