...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maxDurationSecondsInput", GoGetter: "MaxDurationSecondsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "publicDetailsInput", GoGetter: "PublicDetailsInput"},
			_jsii_.MemberMethod{JsiiMethod: "putPublicDetails", GoMethod: "PutPublicDetails"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxDurationSeconds", GoMethod: "ResetMaxDurationSeconds"},
			_jsii_.MemberMethod{JsiiMethod: "resetMeta", GoMethod: "ResetMeta"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPublicDetails", GoMethod: "ResetPublicDetails"},
			_jsii_.MemberMethod{JsiiMethod: "resetRequireSignedUrls", GoMethod: "ResetRequireSignedUrls"},
			_jsii_.MemberMethod{JsiiMethod: "resetScheduledDeletion", GoMethod: "ResetScheduledDeletion"},
			_jsii_.MemberMethod{JsiiMethod: "resetThumbnailTimestampPct", GoMethod: "ResetThumbnailTimestampPct"},
			_jsii_.MemberMethod{JsiiMethod: "resetUid", GoMethod: "ResetUid"},
			_jsii_.MemberMethod{JsiiMethod: "resetUploadExpiry", GoMethod: "ResetUploadExpiry"},
			_jsii_.MemberProperty{JsiiProperty: "scheduledDeletion", GoGetter: "ScheduledDeletion"},
			_jsii_.MemberProperty{JsiiProperty: "scheduledDeletionInput", GoGetter: "ScheduledDeletionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "thumbnail", GoGetter: "Thumbnail"},
			_jsii_.MemberProperty{JsiiProperty: "thumbnailTimestampPct", GoGetter: "ThumbnailTimestampPct"},
			_jsii_.MemberProperty{JsiiProperty: "thumbnailTimestampPctInput", GoGetter: "ThumbnailTimestampPctInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*StreamPublicDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.stream.StreamPublicDetailsOutputReference",
		reflect.TypeOf((*StreamPublicDetailsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "channelLink", GoGetter: "ChannelLink"},
			_jsii_.MemberProperty{JsiiProperty: "channelLinkInput", GoGetter: "ChannelLinkInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetChannelLink", GoMethod: "ResetChannelLink"},
			_jsii_.MemberMethod{JsiiMethod: "resetLogo", GoMethod: "ResetLogo"},
			_jsii_.MemberMethod{JsiiMethod: "resetShareLink", GoMethod: "ResetShareLink"},
			...
			_jsii_.MemberProperty{JsiiProperty: "shareLinkInput", GoGetter: "ShareLinkInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "errorReasonCode", GoGetter: "ErrorReasonCode"},
			_jsii_.MemberProperty{JsiiProperty: "errorReasonText", GoGetter: "ErrorReasonText"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "pctComplete", GoGetter: "PctComplete"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "created", GoGetter: "Created"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "downloadedFrom", GoGetter: "DownloadedFrom"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
