...
type jsiiProxy_UserGroup struct {
	internal.Type__cdktnTerraformResource
}

func (j *jsiiProxy_UserGroup) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_UserGroup) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_UserGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_UserGroup) CreatedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdOn",
...
func (j *jsiiProxy_UserGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_UserGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserGroup) ModifiedOn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modifiedOn",
...
func (j *jsiiProxy_UserGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_UserGroup) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_UserGroup) Node() constructs.Node {
...
func (j *jsiiProxy_UserGroup) Policies() UserGroupPoliciesList {
	var returns UserGroupPoliciesList
	_jsii_.Get(
		j,
		"policies",
		&returns,
...
func (j *jsiiProxy_UserGroup) PoliciesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policiesInput",
...
func (j *jsiiProxy_UserGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_UserGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_UserGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewUserGroup(scope constructs.Construct, id *string, config *UserGroupConfig) UserGroup {
	...
	if err := validateNewUserGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_UserGroup)SetAccountId(val *string) {
...
func (j *jsiiProxy_UserGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_UserGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_UserGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func UserGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateUserGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func UserGroup_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.userGroup.UserGroup",
...
func (u *jsiiProxy_UserGroup) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_UserGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (u *jsiiProxy_UserGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (u *jsiiProxy_UserGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (u *jsiiProxy_UserGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (u *jsiiProxy_UserGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (u *jsiiProxy_UserGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (u *jsiiProxy_UserGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (u *jsiiProxy_UserGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (u *jsiiProxy_UserGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UserGroup) MoveFromId(id *string) {
...
func (u *jsiiProxy_UserGroup) MoveToId(id *string) {
...
func (u *jsiiProxy_UserGroup) OverrideLogicalId(newLogicalId *string) {
...
func (u *jsiiProxy_UserGroup) PutPolicies(value interface{}) {
	if err := u.validatePutPoliciesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		u,
...
func (u *jsiiProxy_UserGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (u *jsiiProxy_UserGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UserGroup) ResetPolicies() {
	_jsii_.InvokeVoid(
		u,
		"resetPolicies",
		nil, // no parameters
...
func (u *jsiiProxy_UserGroup) ToString() *string {
	var returns *string
...
func (u *jsiiProxy_UserGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
