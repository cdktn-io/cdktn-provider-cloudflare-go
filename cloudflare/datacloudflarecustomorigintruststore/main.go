...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomOriginTrustStore)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customOriginTrustStoreId", GoGetter: "CustomOriginTrustStoreId"},
			_jsii_.MemberProperty{JsiiProperty: "customOriginTrustStoreIdInput", GoGetter: "CustomOriginTrustStoreIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomOriginTrustStoreId", GoMethod: "ResetCustomOriginTrustStoreId"},
