# CDKTN Go bindings for cloudflare/cloudflare provider version 5.21.1

This repo builds and publishes the [Terraform cloudflare provider](https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-cloudflare/blob/main/docs/API.go.md).
...
* [Terraform cloudflare provider](https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1)
