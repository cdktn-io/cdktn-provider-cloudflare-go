...
func (j *jsiiProxy_PagesProjectDeploymentConfigsProductionKvNamespacesMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPagesProjectDeploymentConfigsProductionKvNamespacesMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PagesProjectDeploymentConfigsProductionKvNamespacesMap {
	_init_.Initialize()
...
func NewPagesProjectDeploymentConfigsProductionKvNamespacesMap_Override(p PagesProjectDeploymentConfigsProductionKvNamespacesMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsProductionKvNamespacesMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsProductionKvNamespacesMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsProductionKvNamespacesMap) Resolve(context cdktn.IResolveContext) interface{} {
