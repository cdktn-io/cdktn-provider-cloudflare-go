...
func (z *jsiiProxy_ZeroTrustGatewayLoggingSettingsByRuleTypeHttpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustGatewayLoggingSettingsByRuleTypeHttpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
