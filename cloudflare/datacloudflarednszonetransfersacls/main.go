...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareDnsZoneTransfersAcls)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareDnsZoneTransfersAclsResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
