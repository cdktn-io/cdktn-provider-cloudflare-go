...
func (d *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
