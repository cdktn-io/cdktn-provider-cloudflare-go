...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrusttunnelcloudflaredroute/internal"
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) DeletedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletedAt",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) TunnelId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tunnelId",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) TunnelIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tunnelIdInput",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) VirtualNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"virtualNetworkId",
...
func (j *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) VirtualNetworkIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewZeroTrustTunnelCloudflaredRoute(scope constructs.Construct, id *string, config *ZeroTrustTunnelCloudflaredRouteConfig) ZeroTrustTunnelCloudflaredRoute {
	...
	if err := validateNewZeroTrustTunnelCloudflaredRouteParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ZeroTrustTunnelCloudflaredRoute_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.zeroTrustTunnelCloudflaredRoute.ZeroTrustTunnelCloudflaredRoute",
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) ResetComment() {
	_jsii_.InvokeVoid(
		z,
		"resetComment",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) ResetVirtualNetworkId() {
	_jsii_.InvokeVoid(
		z,
		"resetVirtualNetworkId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustTunnelCloudflaredRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
