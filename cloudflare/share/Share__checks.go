...
func (s *jsiiProxy_Share) validatePutRecipientsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ShareRecipients; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Share) validatePutResourcesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ShareResources; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Share) validateSetAccountIdParameters(val *string) error {
	if val == nil {
