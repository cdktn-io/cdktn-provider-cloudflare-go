...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) Success() cdktf.IResolvable {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DataCloudflareEmailRoutingDns_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
