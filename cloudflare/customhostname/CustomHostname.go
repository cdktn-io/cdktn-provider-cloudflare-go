...
func (c *jsiiProxy_CustomHostname) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomHostname) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomHostname) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
