...
func (p *jsiiProxy_PageRuleActionsCacheKeyFieldsUserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PageRuleActionsCacheKeyFieldsUserOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
