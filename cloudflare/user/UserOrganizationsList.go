...
func (j *jsiiProxy_UserOrganizationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewUserOrganizationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) UserOrganizationsList {
	_init_.Initialize()
...
func NewUserOrganizationsList_Override(u UserOrganizationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_UserOrganizationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (u *jsiiProxy_UserOrganizationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (u *jsiiProxy_UserOrganizationsList) Resolve(context cdktn.IResolveContext) interface{} {
