...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) Get(index *float64) DataCloudflareZeroTrustDexTestsResultTargetPoliciesOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataCloudflareZeroTrustDexTestsResultTargetPoliciesOutputReference
...
func (d *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDexTestsResultTargetPoliciesList) ToString() *string {
	var returns *string
