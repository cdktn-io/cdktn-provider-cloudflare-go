...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bmCookieEnabledInput", GoGetter: "BmCookieEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "cfRobotsVariant", GoGetter: "CfRobotsVariant"},
			_jsii_.MemberProperty{JsiiProperty: "cfRobotsVariantInput", GoGetter: "CfRobotsVariantInput"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "crawlerProtection", GoGetter: "CrawlerProtection"},
			_jsii_.MemberProperty{JsiiProperty: "crawlerProtectionInput", GoGetter: "CrawlerProtectionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "isRobotsTxtManagedInput", GoGetter: "IsRobotsTxtManagedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBmCookieEnabled", GoMethod: "ResetBmCookieEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetCfRobotsVariant", GoMethod: "ResetCfRobotsVariant"},
			_jsii_.MemberMethod{JsiiMethod: "resetCrawlerProtection", GoMethod: "ResetCrawlerProtection"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsRobotsTxtManaged", GoMethod: "ResetIsRobotsTxtManaged"},
