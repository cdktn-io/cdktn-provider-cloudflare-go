...
func (z *jsiiProxy_ZeroTrustGatewayPolicyRuleSettingsDnsResolversOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustGatewayPolicyRuleSettingsDnsResolversOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
