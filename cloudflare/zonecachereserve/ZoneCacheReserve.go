...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zonecachereserve/internal"
...
func (j *jsiiProxy_ZoneCacheReserve) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZoneCacheReserve) Editable() cdktn.IResolvable {
...
func (j *jsiiProxy_ZoneCacheReserve) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZoneCacheReserve) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZoneCacheReserve) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZoneCacheReserve) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZoneCacheReserve)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZoneCacheReserve)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZoneCacheReserve)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZoneCacheReserve_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZoneCacheReserve) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZoneCacheReserve) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZoneCacheReserve) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZoneCacheReserve) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZoneCacheReserve) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZoneCacheReserve) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
