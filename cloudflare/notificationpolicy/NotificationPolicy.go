...
func (j *jsiiProxy_NotificationPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NotificationPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NotificationPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NotificationPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NotificationPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NotificationPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NotificationPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NotificationPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NotificationPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NotificationPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NotificationPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NotificationPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NotificationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NotificationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NotificationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
