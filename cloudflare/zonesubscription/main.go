...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "currentPeriodEnd", GoGetter: "CurrentPeriodEnd"},
			_jsii_.MemberProperty{JsiiProperty: "currentPeriodStart", GoGetter: "CurrentPeriodStart"},
