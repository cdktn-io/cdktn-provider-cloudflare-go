...
type ZeroTrustAccessGroupExcludeOutputReference interface {
	...
	CloudflareAccountMember() ZeroTrustAccessGroupExcludeCloudflareAccountMemberOutputReference
	...
	LinkedAppToken() ZeroTrustAccessGroupExcludeLinkedAppTokenOutputReference
	...
	PutCloudflareAccountMember(value *ZeroTrustAccessGroupExcludeCloudflareAccountMember)
	...
	PutLinkedAppToken(value *ZeroTrustAccessGroupExcludeLinkedAppToken)
...
func (j *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) CloudflareAccountMember() ZeroTrustAccessGroupExcludeCloudflareAccountMemberOutputReference {
	var returns ZeroTrustAccessGroupExcludeCloudflareAccountMemberOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) CloudflareAccountMemberInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) LinkedAppToken() ZeroTrustAccessGroupExcludeLinkedAppTokenOutputReference {
	var returns ZeroTrustAccessGroupExcludeLinkedAppTokenOutputReference
	_jsii_.Get(
		j,
		"linkedAppToken",
		&returns,
...
func (j *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) LinkedAppTokenInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"linkedAppTokenInput",
...
func (z *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) PutCloudflareAccountMember(value *ZeroTrustAccessGroupExcludeCloudflareAccountMember) {
...
func (z *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) PutLinkedAppToken(value *ZeroTrustAccessGroupExcludeLinkedAppToken) {
...
func (z *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) ResetCloudflareAccountMember() {
	_jsii_.InvokeVoid(
		z,
		"resetCloudflareAccountMember",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessGroupExcludeOutputReference) ResetLinkedAppToken() {
	_jsii_.InvokeVoid(
		z,
		"resetLinkedAppToken",
		nil, // no parameters
