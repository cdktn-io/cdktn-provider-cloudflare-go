...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessGroupExcludeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessGroupExcludeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustAccessGroupExcludeList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessGroupExcludeList_Override(d DataCloudflareZeroTrustAccessGroupExcludeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessGroupExcludeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupExcludeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupExcludeList) Resolve(context cdktn.IResolveContext) interface{} {
