...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enforceDnsOnly", GoGetter: "EnforceDnsOnly"},
			_jsii_.MemberProperty{JsiiProperty: "enforceDnsOnlyInput", GoGetter: "EnforceDnsOnlyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putZoneDefaults", GoMethod: "PutZoneDefaults"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccountId", GoMethod: "ResetAccountId"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnforceDnsOnly", GoMethod: "ResetEnforceDnsOnly"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetZoneDefaults", GoMethod: "ResetZoneDefaults"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExpire", GoMethod: "ResetExpire"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinTtl", GoMethod: "ResetMinTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetMname", GoMethod: "ResetMname"},
			_jsii_.MemberMethod{JsiiMethod: "resetRefresh", GoMethod: "ResetRefresh"},
			_jsii_.MemberMethod{JsiiMethod: "resetRetry", GoMethod: "ResetRetry"},
			_jsii_.MemberMethod{JsiiMethod: "resetRname", GoMethod: "ResetRname"},
