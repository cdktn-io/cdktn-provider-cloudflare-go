...
func (j *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList_Override(d DataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDnsLocationsResultEndpointsDohNetworksList) Resolve(context cdktn.IResolveContext) interface{} {
