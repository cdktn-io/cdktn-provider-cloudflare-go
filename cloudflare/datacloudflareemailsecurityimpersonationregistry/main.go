...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "impersonationRegistryId", GoGetter: "ImpersonationRegistryId"},
			_jsii_.MemberProperty{JsiiProperty: "impersonationRegistryIdInput", GoGetter: "ImpersonationRegistryIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImpersonationRegistryId", GoMethod: "ResetImpersonationRegistryId"},
