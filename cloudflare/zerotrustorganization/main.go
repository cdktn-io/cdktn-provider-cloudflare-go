...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWarpAuthNonBrowser401", GoMethod: "ResetWarpAuthNonBrowser401"},
			...
			_jsii_.MemberProperty{JsiiProperty: "warpAuthNonBrowser401Input", GoGetter: "WarpAuthNonBrowser401Input"},
