...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) CaseSensitive() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) Deprecated() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"deprecated",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) Enabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) Secret() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"secret",
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference_Override(d DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
