...
func (j *jsiiProxy_StreamLiveInput) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StreamLiveInput) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StreamLiveInput) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StreamLiveInput) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_StreamLiveInput)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StreamLiveInput)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StreamLiveInput)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StreamLiveInput_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StreamLiveInput) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamLiveInput) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StreamLiveInput) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StreamLiveInput) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamLiveInput) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
