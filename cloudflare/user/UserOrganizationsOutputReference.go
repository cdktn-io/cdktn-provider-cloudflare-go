...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/user/internal"
...
func (u *jsiiProxy_UserOrganizationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserOrganizationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
