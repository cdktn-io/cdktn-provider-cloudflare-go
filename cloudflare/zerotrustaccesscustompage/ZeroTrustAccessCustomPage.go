...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustaccesscustompage/internal"
...
type jsiiProxy_ZeroTrustAccessCustomPage struct {
	internal.Type__cdktnTerraformResource
}

func (j *jsiiProxy_ZeroTrustAccessCustomPage) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) CustomHtml() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customHtml",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) CustomHtmlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customHtmlInput",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewZeroTrustAccessCustomPage(scope constructs.Construct, id *string, config *ZeroTrustAccessCustomPageConfig) ZeroTrustAccessCustomPage {
	...
	if err := validateNewZeroTrustAccessCustomPageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZeroTrustAccessCustomPage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateZeroTrustAccessCustomPage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ZeroTrustAccessCustomPage_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.zeroTrustAccessCustomPage.ZeroTrustAccessCustomPage",
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustAccessCustomPage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
