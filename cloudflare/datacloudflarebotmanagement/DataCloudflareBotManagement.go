...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarebotmanagement/internal"
...
func (j *jsiiProxy_DataCloudflareBotManagement) CrawlerProtection() *string {
	var returns *string
	_jsii_.Get(
		j,
		"crawlerProtection",
...
func (j *jsiiProxy_DataCloudflareBotManagement) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareBotManagement) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareBotManagement) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareBotManagement) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareBotManagement) SbfmDefinitelyAutomated() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareBotManagement) SbfmLikelyAutomated() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sbfmLikelyAutomated",
...
func (j *jsiiProxy_DataCloudflareBotManagement) SbfmVerifiedBots() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sbfmVerifiedBots",
...
func (j *jsiiProxy_DataCloudflareBotManagement) StaleZoneConfiguration() DataCloudflareBotManagementStaleZoneConfigurationOutputReference {
	var returns DataCloudflareBotManagementStaleZoneConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareBotManagement) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareBotManagement) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DataCloudflareBotManagement) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewDataCloudflareBotManagement(scope constructs.Construct, id *string, config *DataCloudflareBotManagementConfig) DataCloudflareBotManagement {
	...
	if err := validateNewDataCloudflareBotManagementParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareBotManagement_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareBotManagement.DataCloudflareBotManagement",
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareBotManagement) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareBotManagement) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareBotManagement) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareBotManagement) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareBotManagement) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareBotManagement) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
