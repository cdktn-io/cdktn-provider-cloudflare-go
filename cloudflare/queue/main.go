...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "consumersTotalCount", GoGetter: "ConsumersTotalCount"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "deliveryDelay", GoGetter: "DeliveryDelay"},
			_jsii_.MemberProperty{JsiiProperty: "deliveryDelayInput", GoGetter: "DeliveryDelayInput"},
			_jsii_.MemberProperty{JsiiProperty: "deliveryPaused", GoGetter: "DeliveryPaused"},
			_jsii_.MemberProperty{JsiiProperty: "deliveryPausedInput", GoGetter: "DeliveryPausedInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDeliveryDelay", GoMethod: "ResetDeliveryDelay"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeliveryPaused", GoMethod: "ResetDeliveryPaused"},
