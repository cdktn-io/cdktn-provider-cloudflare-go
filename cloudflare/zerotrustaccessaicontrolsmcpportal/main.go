...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowCodeModeInput", GoGetter: "AllowCodeModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "codeMode", GoGetter: "CodeMode"},
			_jsii_.MemberProperty{JsiiProperty: "codeModeInput", GoGetter: "CodeModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowCodeMode", GoMethod: "ResetAllowCodeMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetCodeMode", GoMethod: "ResetCodeMode"},
