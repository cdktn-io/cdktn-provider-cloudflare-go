...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustgatewayproxyendpoint/internal"
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZeroTrustGatewayProxyEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZeroTrustGatewayProxyEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustGatewayProxyEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustGatewayProxyEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustGatewayProxyEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustGatewayProxyEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustGatewayProxyEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustGatewayProxyEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
