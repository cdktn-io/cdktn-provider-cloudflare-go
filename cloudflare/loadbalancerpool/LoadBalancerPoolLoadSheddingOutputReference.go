...
func NewLoadBalancerPoolLoadSheddingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LoadBalancerPoolLoadSheddingOutputReference {
	_init_.Initialize()
...
func NewLoadBalancerPoolLoadSheddingOutputReference_Override(l LoadBalancerPoolLoadSheddingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
