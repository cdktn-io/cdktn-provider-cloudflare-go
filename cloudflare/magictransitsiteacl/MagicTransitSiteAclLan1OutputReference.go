...
func (m *jsiiProxy_MagicTransitSiteAclLan1OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MagicTransitSiteAclLan1OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
