...
func (j *jsiiProxy_DataCloudflareTokenValidationRulesListResultSelectorExcludeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareTokenValidationRulesListResultSelectorExcludeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareTokenValidationRulesListResultSelectorExcludeList {
	_init_.Initialize()
...
func NewDataCloudflareTokenValidationRulesListResultSelectorExcludeList_Override(d DataCloudflareTokenValidationRulesListResultSelectorExcludeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareTokenValidationRulesListResultSelectorExcludeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareTokenValidationRulesListResultSelectorExcludeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareTokenValidationRulesListResultSelectorExcludeList) Resolve(context cdktn.IResolveContext) interface{} {
