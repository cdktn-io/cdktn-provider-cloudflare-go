...
func (j *jsiiProxy_ZeroTrustGatewayLogging) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustGatewayLogging) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustGatewayLogging) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustGatewayLogging) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustGatewayLogging) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.13.0/docs/resources/zero_trust_gateway_logging cloudflare_zero_trust_gateway_logging} Resource.
...
func ZeroTrustGatewayLogging_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustGatewayLogging) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustGatewayLogging) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustGatewayLogging) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
