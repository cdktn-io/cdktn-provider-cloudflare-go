# CDKTN Go bindings for cloudflare/cloudflare provider version 5.23.0

This repo builds and publishes the [Terraform cloudflare provider](https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform cloudflare provider](https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0)
