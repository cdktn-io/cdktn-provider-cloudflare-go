...
func (j *jsiiProxy_DataCloudflareAccountApiTokenPermissionGroupsList) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareAccountApiTokenPermissionGroupsList) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareAccountApiTokenPermissionGroupsList) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareAccountApiTokenPermissionGroupsList) Provider() cdktf.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/data-sources/account_api_token_permission_groups_list cloudflare_account_api_token_permission_groups_list} Data Source.
...
func DataCloudflareAccountApiTokenPermissionGroupsList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareAccountApiTokenPermissionGroupsList) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareAccountApiTokenPermissionGroupsList) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
