...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareAuthenticatedOriginPullsCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareAuthenticatedOriginPullsCertificateConfig)(nil)).Elem(),
	)
}
