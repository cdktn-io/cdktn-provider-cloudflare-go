...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putTcpConfig", GoMethod: "PutTcpConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTcpConfig", GoMethod: "ResetTcpConfig"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tcpConfigInput", GoGetter: "TcpConfigInput"},
