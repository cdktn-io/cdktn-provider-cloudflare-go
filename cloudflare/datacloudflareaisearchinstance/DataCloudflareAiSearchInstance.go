...
func (d *jsiiProxy_DataCloudflareAiSearchInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareAiSearchInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
