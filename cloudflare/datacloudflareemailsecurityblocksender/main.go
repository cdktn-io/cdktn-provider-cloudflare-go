...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "patternId", GoGetter: "PatternId"},
			_jsii_.MemberProperty{JsiiProperty: "patternIdInput", GoGetter: "PatternIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPatternId", GoMethod: "ResetPatternId"},
