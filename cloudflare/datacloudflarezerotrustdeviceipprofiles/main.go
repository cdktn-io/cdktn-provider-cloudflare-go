...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustDeviceIpProfiles)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustDeviceIpProfilesResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
