...
func (j *jsiiProxy_DataCloudflareZeroTrustDeviceCustomProfilesResultFallbackDomainsList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataCloudflareZeroTrustDeviceCustomProfilesResultFallbackDomainsListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
