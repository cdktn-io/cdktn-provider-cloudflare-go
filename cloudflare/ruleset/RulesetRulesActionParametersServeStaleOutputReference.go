...
func (j *jsiiProxy_RulesetRulesActionParametersServeStaleOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRulesetRulesActionParametersServeStaleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) RulesetRulesActionParametersServeStaleOutputReference {
	_init_.Initialize()

	if err := validateNewRulesetRulesActionParametersServeStaleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewRulesetRulesActionParametersServeStaleOutputReference_Override(r RulesetRulesActionParametersServeStaleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_RulesetRulesActionParametersServeStaleOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RulesetRulesActionParametersServeStaleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RulesetRulesActionParametersServeStaleOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (r *jsiiProxy_RulesetRulesActionParametersServeStaleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RulesetRulesActionParametersServeStaleOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
