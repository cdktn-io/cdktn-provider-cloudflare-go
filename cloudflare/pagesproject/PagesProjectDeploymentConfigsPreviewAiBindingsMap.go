...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewAiBindingsMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPagesProjectDeploymentConfigsPreviewAiBindingsMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PagesProjectDeploymentConfigsPreviewAiBindingsMap {
	_init_.Initialize()
...
func NewPagesProjectDeploymentConfigsPreviewAiBindingsMap_Override(p PagesProjectDeploymentConfigsPreviewAiBindingsMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewAiBindingsMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewAiBindingsMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewAiBindingsMap) Resolve(context cdktn.IResolveContext) interface{} {
