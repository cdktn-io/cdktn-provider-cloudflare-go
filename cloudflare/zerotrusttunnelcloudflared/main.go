...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configSrcInput", GoGetter: "ConfigSrcInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetConfigSrc", GoMethod: "ResetConfigSrc"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tunnelSecret", GoGetter: "TunnelSecret"},
