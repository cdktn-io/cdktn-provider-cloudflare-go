...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap {
	_init_.Initialize()
...
func NewPagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap_Override(p PagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewAnalyticsEngineDatasetsMap) Resolve(context cdktn.IResolveContext) interface{} {
