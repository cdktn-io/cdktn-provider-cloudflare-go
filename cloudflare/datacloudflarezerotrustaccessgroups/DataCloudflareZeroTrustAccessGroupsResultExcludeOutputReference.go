...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupsResultExcludeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
