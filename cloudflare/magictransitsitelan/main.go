...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isBreakoutInput", GoGetter: "IsBreakoutInput"},
			_jsii_.MemberProperty{JsiiProperty: "isPrioritized", GoGetter: "IsPrioritized"},
			_jsii_.MemberProperty{JsiiProperty: "isPrioritizedInput", GoGetter: "IsPrioritizedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsPrioritized", GoMethod: "ResetIsPrioritized"},
