...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareApiShieldSchemas)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "omitSource", GoGetter: "OmitSource"},
			_jsii_.MemberProperty{JsiiProperty: "omitSourceInput", GoGetter: "OmitSourceInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareApiShieldSchemasResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
