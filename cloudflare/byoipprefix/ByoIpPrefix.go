...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/byoipprefix/internal"
...
func (b *jsiiProxy_ByoIpPrefix) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_ByoIpPrefix) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_ByoIpPrefix) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
