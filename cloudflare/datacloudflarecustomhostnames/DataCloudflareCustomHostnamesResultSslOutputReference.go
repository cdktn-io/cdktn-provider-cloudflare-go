...
func (d *jsiiProxy_DataCloudflareCustomHostnamesResultSslOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCustomHostnamesResultSslOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
