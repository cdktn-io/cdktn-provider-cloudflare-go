...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareCertificatePacksResultDcvDelegationRecords)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareCertificatePacks.DataCloudflareCertificatePacksResultDcvDelegationRecordsList",
		reflect.TypeOf((*DataCloudflareCertificatePacksResultDcvDelegationRecordsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCertificatePacksResultDcvDelegationRecordsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
