...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRedactPii", GoMethod: "ResetRedactPii"},
			_jsii_.MemberMethod{JsiiMethod: "resetSettingsByRuleType", GoMethod: "ResetSettingsByRuleType"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLogAll", GoMethod: "ResetLogAll"},
			_jsii_.MemberMethod{JsiiMethod: "resetLogBlocks", GoMethod: "ResetLogBlocks"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetL4", GoMethod: "ResetL4"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
