...
func (d *jsiiProxy_DataCloudflareLoadBalancerPoolsResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareLoadBalancerPoolsResultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
