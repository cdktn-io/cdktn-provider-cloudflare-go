...
func (j *jsiiProxy_DataCloudflareAiGateway) LogClassification() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"logClassification",
...
func (d *jsiiProxy_DataCloudflareAiGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
