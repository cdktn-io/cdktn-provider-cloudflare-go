...
func (r *jsiiProxy_RulesetRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RulesetRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
