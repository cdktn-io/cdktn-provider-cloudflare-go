...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/customcsr/internal"
...
func (c *jsiiProxy_CustomCsr) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomCsr) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
