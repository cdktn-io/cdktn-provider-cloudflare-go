...
func (l *jsiiProxy_LoadBalancerMonitor) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (l *jsiiProxy_LoadBalancerMonitor) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (l *jsiiProxy_LoadBalancerMonitor) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
