...
func (j *jsiiProxy_ZeroTrustList) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustList) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustList) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustList) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustList) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/zero_trust_list cloudflare_zero_trust_list} Resource.
...
func ZeroTrustList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustList) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustList) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustList) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
