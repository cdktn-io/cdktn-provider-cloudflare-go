...
func (z *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *ZeroTrustAccessGroupRequireGithubOrganization; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewZeroTrustAccessGroupRequireGithubOrganizationOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
