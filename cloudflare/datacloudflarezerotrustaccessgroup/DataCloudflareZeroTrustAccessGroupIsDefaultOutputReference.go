...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupIsDefaultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessGroupIsDefaultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
