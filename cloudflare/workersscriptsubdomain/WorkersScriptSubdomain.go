...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/workersscriptsubdomain/internal"
...
func (j *jsiiProxy_WorkersScriptSubdomain) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_WorkersScriptSubdomain) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_WorkersScriptSubdomain) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_WorkersScriptSubdomain) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func WorkersScriptSubdomain_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkersScriptSubdomain) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkersScriptSubdomain) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WorkersScriptSubdomain) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
