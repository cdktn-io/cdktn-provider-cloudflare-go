...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList)SetWrapsSet(val *bool) {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) ComputeFqn() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) Get(index *float64) ZeroTrustAccessApplicationSaasAppCustomClaimsOutputReference {
	if err := z.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ZeroTrustAccessApplicationSaasAppCustomClaimsOutputReference
...
func (z *jsiiProxy_ZeroTrustAccessApplicationSaasAppCustomClaimsList) ToString() *string {
	var returns *string
