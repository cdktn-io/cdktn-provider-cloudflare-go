...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceTokenId", GoMethod: "ResetServiceTokenId"},
			_jsii_.MemberMethod{JsiiMethod: "resetZoneId", GoMethod: "ResetZoneId"},
			_jsii_.MemberProperty{JsiiProperty: "serviceTokenId", GoGetter: "ServiceTokenId"},
			_jsii_.MemberProperty{JsiiProperty: "serviceTokenIdInput", GoGetter: "ServiceTokenIdInput"},
