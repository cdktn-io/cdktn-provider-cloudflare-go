...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultExcludeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
