...
func (j *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.13.0/docs/resources/zero_trust_access_mtls_hostname_settings cloudflare_zero_trust_access_mtls_hostname_settings} Resource.
...
func ZeroTrustAccessMtlsHostnameSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustAccessMtlsHostnameSettings) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
