...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarezerotrustaccessmtlscertificates/internal"
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareZeroTrustAccessMtlsCertificates_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificates) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
