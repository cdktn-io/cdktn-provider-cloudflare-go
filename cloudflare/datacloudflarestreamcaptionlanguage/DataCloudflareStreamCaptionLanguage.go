...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarestreamcaptionlanguage/internal"
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) Identifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identifier",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) IdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identifierInput",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) Label() *string {
	var returns *string
	_jsii_.Get(
		j,
		"label",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) Language() *string {
	var returns *string
	_jsii_.Get(
		j,
		"language",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_DataCloudflareStreamCaptionLanguage) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareStreamCaptionLanguage(scope constructs.Construct, id *string, config *DataCloudflareStreamCaptionLanguageConfig) DataCloudflareStreamCaptionLanguage {
	...
	if err := validateNewDataCloudflareStreamCaptionLanguageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareStreamCaptionLanguage_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareStreamCaptionLanguage.DataCloudflareStreamCaptionLanguage",
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareStreamCaptionLanguage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
