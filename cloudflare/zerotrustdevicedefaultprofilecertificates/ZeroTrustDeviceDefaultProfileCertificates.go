...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustdevicedefaultprofilecertificates/internal"
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewZeroTrustDeviceDefaultProfileCertificates(scope constructs.Construct, id *string, config *ZeroTrustDeviceDefaultProfileCertificatesConfig) ZeroTrustDeviceDefaultProfileCertificates {
	...
	if err := validateNewZeroTrustDeviceDefaultProfileCertificatesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ZeroTrustDeviceDefaultProfileCertificates_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.zeroTrustDeviceDefaultProfileCertificates.ZeroTrustDeviceDefaultProfileCertificates",
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustDeviceDefaultProfileCertificates) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
