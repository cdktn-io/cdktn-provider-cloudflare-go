...
func (j *jsiiProxy_DataCloudflareAiGatewaysResultList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareAiGatewaysResultList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareAiGatewaysResultList {
	_init_.Initialize()
...
func NewDataCloudflareAiGatewaysResultList_Override(d DataCloudflareAiGatewaysResultList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareAiGatewaysResultList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareAiGatewaysResultList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareAiGatewaysResultList) Resolve(context cdktn.IResolveContext) interface{} {
