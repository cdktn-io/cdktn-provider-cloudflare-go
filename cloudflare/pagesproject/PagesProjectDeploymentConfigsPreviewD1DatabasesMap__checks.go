...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewD1DatabasesMap) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *map[string]*PagesProjectDeploymentConfigsPreviewD1Databases; received %#v (a %T)", val, val)
		}
	}
