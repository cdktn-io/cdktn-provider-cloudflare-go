...
func (j *jsiiProxy_ZeroTrustDlpEntryProfilesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewZeroTrustDlpEntryProfilesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDlpEntryProfilesList {
	_init_.Initialize()
...
func NewZeroTrustDlpEntryProfilesList_Override(z ZeroTrustDlpEntryProfilesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDlpEntryProfilesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDlpEntryProfilesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDlpEntryProfilesList) Resolve(context cdktf.IResolveContext) interface{} {
