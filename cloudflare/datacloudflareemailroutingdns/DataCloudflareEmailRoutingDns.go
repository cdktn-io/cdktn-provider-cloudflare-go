...
type jsiiProxy_DataCloudflareEmailRoutingDns struct {
	internal.Type__cdktnTerraformDataSource
}

func (j *jsiiProxy_DataCloudflareEmailRoutingDns) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) SubdomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subdomainInput",
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewDataCloudflareEmailRoutingDns(scope constructs.Construct, id *string, config *DataCloudflareEmailRoutingDnsConfig) DataCloudflareEmailRoutingDns {
	...
	if err := validateNewDataCloudflareEmailRoutingDnsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareEmailRoutingDns)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareEmailRoutingDns_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareEmailRoutingDns_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataCloudflareEmailRoutingDns_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareEmailRoutingDns.DataCloudflareEmailRoutingDns",
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) ResetSubdomain() {
	_jsii_.InvokeVoid(
		d,
		"resetSubdomain",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareEmailRoutingDns) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
