...
func (a *jsiiProxy_ApiShieldOperation) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApiShieldOperation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiShieldOperation) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApiShieldOperation) MoveToId(id *string) {
...
func (a *jsiiProxy_ApiShieldOperation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiShieldOperation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
