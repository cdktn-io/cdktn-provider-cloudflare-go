...
func (j *jsiiProxy_ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustAccessPolicyRequireExternalEvaluationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference {
	_init_.Initialize()

	if err := validateNewZeroTrustAccessPolicyRequireExternalEvaluationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewZeroTrustAccessPolicyRequireExternalEvaluationOutputReference_Override(z ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (z *jsiiProxy_ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyRequireExternalEvaluationOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
