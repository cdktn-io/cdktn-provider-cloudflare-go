...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustNetworkHostnameRoute)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hostnameRouteId", GoGetter: "HostnameRouteId"},
			_jsii_.MemberProperty{JsiiProperty: "hostnameRouteIdInput", GoGetter: "HostnameRouteIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHostnameRouteId", GoMethod: "ResetHostnameRouteId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustNetworkHostnameRouteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareZeroTrustNetworkHostnameRoute.DataCloudflareZeroTrustNetworkHostnameRouteFilter",
		reflect.TypeOf((*DataCloudflareZeroTrustNetworkHostnameRouteFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustNetworkHostnameRouteFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
