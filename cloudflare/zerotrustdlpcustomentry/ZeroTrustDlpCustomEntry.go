...
func (j *jsiiProxy_ZeroTrustDlpCustomEntry) CaseSensitive() cdktf.IResolvable {
...
func (j *jsiiProxy_ZeroTrustDlpCustomEntry) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustDlpCustomEntry) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustDlpCustomEntry) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustDlpCustomEntry) Secret() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"secret",
...
func (j *jsiiProxy_ZeroTrustDlpCustomEntry) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func ZeroTrustDlpCustomEntry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustDlpCustomEntry) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDlpCustomEntry) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustDlpCustomEntry) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
