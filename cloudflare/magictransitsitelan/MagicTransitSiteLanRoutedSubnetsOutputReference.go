...
func (j *jsiiProxy_MagicTransitSiteLanRoutedSubnetsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMagicTransitSiteLanRoutedSubnetsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MagicTransitSiteLanRoutedSubnetsOutputReference {
	_init_.Initialize()
...
func NewMagicTransitSiteLanRoutedSubnetsOutputReference_Override(m MagicTransitSiteLanRoutedSubnetsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MagicTransitSiteLanRoutedSubnetsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MagicTransitSiteLanRoutedSubnetsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MagicTransitSiteLanRoutedSubnetsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MagicTransitSiteLanRoutedSubnetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MagicTransitSiteLanRoutedSubnetsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
