...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*StreamDownloadAudio)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.streamDownload.StreamDownloadAudioOutputReference",
		reflect.TypeOf((*StreamDownloadAudioOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "percentComplete", GoGetter: "PercentComplete"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*StreamDownloadDefault)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.streamDownload.StreamDownloadDefaultOutputReference",
		reflect.TypeOf((*StreamDownloadDefaultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
