...
func (z *jsiiProxy_ZeroTrustAccessIdentityProviderScimConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProviderScimConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
