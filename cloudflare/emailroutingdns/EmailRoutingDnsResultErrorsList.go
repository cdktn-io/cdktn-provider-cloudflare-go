...
func (j *jsiiProxy_EmailRoutingDnsResultErrorsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_EmailRoutingDnsResultErrorsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_EmailRoutingDnsResultErrorsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_EmailRoutingDnsResultErrorsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_EmailRoutingDnsResultErrorsList)SetWrapsSet(val *bool) {
...
func (e *jsiiProxy_EmailRoutingDnsResultErrorsList) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_EmailRoutingDnsResultErrorsList) Get(index *float64) EmailRoutingDnsResultErrorsOutputReference {
	if err := e.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns EmailRoutingDnsResultErrorsOutputReference
...
func (e *jsiiProxy_EmailRoutingDnsResultErrorsList) ToString() *string {
	var returns *string
