...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/loadbalancermonitor/internal"
...
func (l *jsiiProxy_LoadBalancerMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LoadBalancerMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LoadBalancerMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
