...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileIncludeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustDeviceCustomProfileIncludeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDeviceCustomProfileIncludeList {
	_init_.Initialize()
...
func NewZeroTrustDeviceCustomProfileIncludeList_Override(z ZeroTrustDeviceCustomProfileIncludeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileIncludeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileIncludeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileIncludeList) Resolve(context cdktn.IResolveContext) interface{} {
