...
func (p *jsiiProxy_PagesProjectCanonicalDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PagesProjectCanonicalDeploymentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
