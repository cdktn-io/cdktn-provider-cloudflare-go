...
func (j *jsiiProxy_DataCloudflareZeroTrustGatewayProxyEndpointsResultList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustGatewayProxyEndpointsResultList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustGatewayProxyEndpointsResultList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustGatewayProxyEndpointsResultList_Override(d DataCloudflareZeroTrustGatewayProxyEndpointsResultList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustGatewayProxyEndpointsResultList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustGatewayProxyEndpointsResultList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustGatewayProxyEndpointsResultList) Resolve(context cdktn.IResolveContext) interface{} {
