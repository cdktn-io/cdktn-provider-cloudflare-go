...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putTunnel", GoMethod: "PutTunnel"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTunnel", GoMethod: "ResetTunnel"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tunnelInput", GoGetter: "TunnelInput"},
