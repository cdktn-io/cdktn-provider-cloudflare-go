...
func (r *jsiiProxy_R2BucketLockRulesConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_R2BucketLockRulesConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
