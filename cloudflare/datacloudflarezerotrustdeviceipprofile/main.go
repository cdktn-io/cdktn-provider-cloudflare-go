...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustDeviceIpProfile)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustDeviceIpProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareZeroTrustDeviceIpProfile.DataCloudflareZeroTrustDeviceIpProfileFilter",
		reflect.TypeOf((*DataCloudflareZeroTrustDeviceIpProfileFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustDeviceIpProfileFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
