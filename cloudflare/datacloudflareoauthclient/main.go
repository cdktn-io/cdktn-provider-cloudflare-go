...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareOauthClient)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareOauthClient.DataCloudflareOauthClientClientUriVerification",
		reflect.TypeOf((*DataCloudflareOauthClientClientUriVerification)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareOauthClient.DataCloudflareOauthClientClientUriVerificationOutputReference",
		reflect.TypeOf((*DataCloudflareOauthClientClientUriVerificationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareOauthClient.DataCloudflareOauthClientConfig",
		reflect.TypeOf((*DataCloudflareOauthClientConfig)(nil)).Elem(),
	)
}
