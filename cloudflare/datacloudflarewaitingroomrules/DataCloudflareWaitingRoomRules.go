...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflarewaitingroomrules/internal"
...
func (j *jsiiProxy_DataCloudflareWaitingRoomRules) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomRules) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareWaitingRoomRules) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DataCloudflareWaitingRoomRules_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareWaitingRoomRules) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareWaitingRoomRules) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
