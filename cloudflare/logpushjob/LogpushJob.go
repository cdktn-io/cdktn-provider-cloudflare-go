...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/logpushjob/internal"
...
func (l *jsiiProxy_LogpushJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LogpushJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LogpushJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
