...
func (z *jsiiProxy_ZeroTrustDlpDatasetDatasetColumnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDlpDatasetDatasetColumnsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
