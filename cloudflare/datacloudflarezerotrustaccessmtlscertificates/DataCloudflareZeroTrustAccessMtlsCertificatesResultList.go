...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificatesResultList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessMtlsCertificatesResultList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareZeroTrustAccessMtlsCertificatesResultList {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessMtlsCertificatesResultList_Override(d DataCloudflareZeroTrustAccessMtlsCertificatesResultList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificatesResultList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificatesResultList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessMtlsCertificatesResultList) Resolve(context cdktn.IResolveContext) interface{} {
