...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileFallbackDomainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustDeviceCustomProfileFallbackDomainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDeviceCustomProfileFallbackDomainsList {
	_init_.Initialize()
...
func NewZeroTrustDeviceCustomProfileFallbackDomainsList_Override(z ZeroTrustDeviceCustomProfileFallbackDomainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileFallbackDomainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileFallbackDomainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileFallbackDomainsList) Resolve(context cdktn.IResolveContext) interface{} {
