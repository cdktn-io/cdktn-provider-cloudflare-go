...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflarePipeline)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflarePipelineConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflarePipeline.DataCloudflarePipelineTables",
		reflect.TypeOf((*DataCloudflarePipelineTables)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflarePipeline.DataCloudflarePipelineTablesList",
		reflect.TypeOf((*DataCloudflarePipelineTablesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflarePipelineTablesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
