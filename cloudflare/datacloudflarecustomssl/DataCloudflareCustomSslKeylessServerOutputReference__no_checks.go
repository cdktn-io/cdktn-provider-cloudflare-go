...
func (d *jsiiProxy_DataCloudflareCustomSslKeylessServerOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataCloudflareCustomSslKeylessServerOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}

func validateNewDataCloudflareCustomSslKeylessServerOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
	return nil
}
