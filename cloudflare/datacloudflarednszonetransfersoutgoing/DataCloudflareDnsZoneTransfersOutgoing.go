...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarednszonetransfersoutgoing/internal"
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) CheckedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"checkedTime",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) CreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTime",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) LastTransferredTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastTransferredTime",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) Peers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"peers",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) SoaSerial() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"soaSerial",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewDataCloudflareDnsZoneTransfersOutgoing(scope constructs.Construct, id *string, config *DataCloudflareDnsZoneTransfersOutgoingConfig) DataCloudflareDnsZoneTransfersOutgoing {
	...
	if err := validateNewDataCloudflareDnsZoneTransfersOutgoingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataCloudflareDnsZoneTransfersOutgoing_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareDnsZoneTransfersOutgoing.DataCloudflareDnsZoneTransfersOutgoing",
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareDnsZoneTransfersOutgoing) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
