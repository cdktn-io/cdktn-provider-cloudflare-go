...
func (z *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
