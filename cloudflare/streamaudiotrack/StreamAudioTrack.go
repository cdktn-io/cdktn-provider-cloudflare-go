...
func (j *jsiiProxy_StreamAudioTrack) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_StreamAudioTrack) AudioIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"audioIdentifier",
...
func (j *jsiiProxy_StreamAudioTrack) AudioIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"audioIdentifierInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_StreamAudioTrack) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_StreamAudioTrack) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StreamAudioTrack) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_StreamAudioTrack) Identifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identifier",
...
func (j *jsiiProxy_StreamAudioTrack) IdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identifierInput",
...
func (j *jsiiProxy_StreamAudioTrack) Label() *string {
	var returns *string
	_jsii_.Get(
		j,
		"label",
...
func (j *jsiiProxy_StreamAudioTrack) LabelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelInput",
...
func (j *jsiiProxy_StreamAudioTrack) Node() constructs.Node {
...
func (j *jsiiProxy_StreamAudioTrack) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_StreamAudioTrack) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StreamAudioTrack) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func NewStreamAudioTrack(scope constructs.Construct, id *string, config *StreamAudioTrackConfig) StreamAudioTrack {
	...
	if err := validateNewStreamAudioTrackParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func StreamAudioTrack_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.streamAudioTrack.StreamAudioTrack",
...
func (s *jsiiProxy_StreamAudioTrack) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StreamAudioTrack) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_StreamAudioTrack) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_StreamAudioTrack) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_StreamAudioTrack) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_StreamAudioTrack) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_StreamAudioTrack) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_StreamAudioTrack) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_StreamAudioTrack) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StreamAudioTrack) MoveFromId(id *string) {
...
func (s *jsiiProxy_StreamAudioTrack) MoveToId(id *string) {
...
func (s *jsiiProxy_StreamAudioTrack) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_StreamAudioTrack) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StreamAudioTrack) ResetAudioIdentifier() {
	_jsii_.InvokeVoid(
		s,
		"resetAudioIdentifier",
		nil, // no parameters
...
func (s *jsiiProxy_StreamAudioTrack) ResetDefault() {
	_jsii_.InvokeVoid(
		s,
		"resetDefault",
		nil, // no parameters
...
func (s *jsiiProxy_StreamAudioTrack) ResetLabel() {
	_jsii_.InvokeVoid(
		s,
		"resetLabel",
		nil, // no parameters
...
func (s *jsiiProxy_StreamAudioTrack) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_StreamAudioTrack) ToString() *string {
	var returns *string
