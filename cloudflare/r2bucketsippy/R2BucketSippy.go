...
func (j *jsiiProxy_R2BucketSippy) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_R2BucketSippy) BucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketName",
...
func (j *jsiiProxy_R2BucketSippy) BucketNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketNameInput",
...
func (j *jsiiProxy_R2BucketSippy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_R2BucketSippy) Destination() R2BucketSippyDestinationOutputReference {
	var returns R2BucketSippyDestinationOutputReference
	_jsii_.Get(
		j,
		"destination",
		&returns,
...
func (j *jsiiProxy_R2BucketSippy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_R2BucketSippy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_R2BucketSippy) Jurisdiction() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jurisdiction",
...
func (j *jsiiProxy_R2BucketSippy) JurisdictionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jurisdictionInput",
...
func (j *jsiiProxy_R2BucketSippy) Node() constructs.Node {
...
func (j *jsiiProxy_R2BucketSippy) Source() R2BucketSippySourceOutputReference {
	var returns R2BucketSippySourceOutputReference
	_jsii_.Get(
		j,
		"source",
		&returns,
...
func (j *jsiiProxy_R2BucketSippy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewR2BucketSippy(scope constructs.Construct, id *string, config *R2BucketSippyConfig) R2BucketSippy {
	...
	if err := validateNewR2BucketSippyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func R2BucketSippy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.r2BucketSippy.R2BucketSippy",
...
func (r *jsiiProxy_R2BucketSippy) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_R2BucketSippy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_R2BucketSippy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_R2BucketSippy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_R2BucketSippy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_R2BucketSippy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_R2BucketSippy) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_R2BucketSippy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_R2BucketSippy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_R2BucketSippy) MoveFromId(id *string) {
...
func (r *jsiiProxy_R2BucketSippy) MoveToId(id *string) {
...
func (r *jsiiProxy_R2BucketSippy) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_R2BucketSippy) PutDestination(value *R2BucketSippyDestination) {
	if err := r.validatePutDestinationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
...
func (r *jsiiProxy_R2BucketSippy) PutSource(value *R2BucketSippySource) {
...
func (r *jsiiProxy_R2BucketSippy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_R2BucketSippy) ResetDestination() {
	_jsii_.InvokeVoid(
		r,
		"resetDestination",
		nil, // no parameters
...
func (r *jsiiProxy_R2BucketSippy) ResetJurisdiction() {
	_jsii_.InvokeVoid(
		r,
		"resetJurisdiction",
		nil, // no parameters
...
func (r *jsiiProxy_R2BucketSippy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_R2BucketSippy) ResetSource() {
	_jsii_.InvokeVoid(
		r,
		"resetSource",
		nil, // no parameters
...
func (r *jsiiProxy_R2BucketSippy) ToString() *string {
	var returns *string
