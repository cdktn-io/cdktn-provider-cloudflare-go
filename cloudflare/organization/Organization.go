...
type Organization interface {
	...
	PutParent(value *OrganizationParent)
	PutProfile(value *OrganizationProfile)
...
func (j *jsiiProxy_Organization) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Organization) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_Organization) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Organization) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Organization) Meta() OrganizationMetaOutputReference {
	var returns OrganizationMetaOutputReference
	_jsii_.Get(
		j,
		"meta",
		&returns,
...
func (j *jsiiProxy_Organization) Parent() OrganizationParentOutputReference {
	var returns OrganizationParentOutputReference
	_jsii_.Get(
		j,
		"parent",
		&returns,
...
func (j *jsiiProxy_Organization) ParentInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_Organization) Profile() OrganizationProfileOutputReference {
	var returns OrganizationProfileOutputReference
	_jsii_.Get(
		j,
		"profile",
		&returns,
...
func (j *jsiiProxy_Organization) ProfileInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"profileInput",
...
func (j *jsiiProxy_Organization) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Organization) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Organization)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Organization)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Organization)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Organization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_Organization) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_Organization) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_Organization) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_Organization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_Organization) PutParent(value *OrganizationParent) {
	if err := o.validatePutParentParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_Organization) PutProfile(value *OrganizationProfile) {
	if err := o.validatePutProfileParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_Organization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_Organization) ResetParent() {
	_jsii_.InvokeVoid(
		o,
		"resetParent",
		nil, // no parameters
...
func (o *jsiiProxy_Organization) ResetProfile() {
	_jsii_.InvokeVoid(
		o,
		"resetProfile",
		nil, // no parameters
...
func (o *jsiiProxy_Organization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
