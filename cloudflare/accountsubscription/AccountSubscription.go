...
func (j *jsiiProxy_AccountSubscription) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AccountSubscription) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccountSubscription) Provider() cdktf.TerraformProvider {
...
func AccountSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AccountSubscription) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccountSubscription) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccountSubscription) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
