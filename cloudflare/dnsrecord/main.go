...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "privateRoutingInput", GoGetter: "PrivateRoutingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPrivateRouting", GoMethod: "ResetPrivateRouting"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv4OnlyInput", GoGetter: "Ipv4OnlyInput"},
			_jsii_.MemberProperty{JsiiProperty: "ipv6Only", GoGetter: "Ipv6Only"},
			_jsii_.MemberProperty{JsiiProperty: "ipv6OnlyInput", GoGetter: "Ipv6OnlyInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetFlattenCname", GoMethod: "ResetFlattenCname"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpv4Only", GoMethod: "ResetIpv4Only"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpv6Only", GoMethod: "ResetIpv6Only"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
