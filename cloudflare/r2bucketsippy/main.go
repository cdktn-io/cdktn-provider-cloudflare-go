...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bucketUrl", GoGetter: "BucketUrl"},
			_jsii_.MemberProperty{JsiiProperty: "bucketUrlInput", GoGetter: "BucketUrlInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBucketUrl", GoMethod: "ResetBucketUrl"},
