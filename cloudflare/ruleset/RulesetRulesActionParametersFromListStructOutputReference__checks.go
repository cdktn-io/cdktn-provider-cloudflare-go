...
func (j *jsiiProxy_RulesetRulesActionParametersFromListStructOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *RulesetRulesActionParametersFromListStruct; received %#v (a %T)", val, val)
		}
	}
...
func validateNewRulesetRulesActionParametersFromListStructOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
