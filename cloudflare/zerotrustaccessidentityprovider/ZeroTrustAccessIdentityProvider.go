...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/resources/zero_trust_access_identity_provider cloudflare_zero_trust_access_identity_provider} Resource.
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
