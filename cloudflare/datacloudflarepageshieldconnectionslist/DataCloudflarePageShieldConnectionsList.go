...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflarePageShieldConnectionsList)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflarePageShieldConnectionsList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflarePageShieldConnectionsList) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePageShieldConnectionsList) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePageShieldConnectionsList) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflarePageShieldConnectionsList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
