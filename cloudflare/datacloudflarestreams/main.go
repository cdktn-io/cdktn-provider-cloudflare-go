...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "includeCounts", GoGetter: "IncludeCounts"},
			_jsii_.MemberProperty{JsiiProperty: "includeCountsInput", GoGetter: "IncludeCountsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "liveInputId", GoGetter: "LiveInputId"},
			_jsii_.MemberProperty{JsiiProperty: "liveInputIdInput", GoGetter: "LiveInputIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIncludeCounts", GoMethod: "ResetIncludeCounts"},
			_jsii_.MemberMethod{JsiiMethod: "resetLimit", GoMethod: "ResetLimit"},
			_jsii_.MemberMethod{JsiiMethod: "resetLiveInputId", GoMethod: "ResetLiveInputId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareStreamsResultPublicDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareStreams.DataCloudflareStreamsResultPublicDetailsOutputReference",
		reflect.TypeOf((*DataCloudflareStreamsResultPublicDetailsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
