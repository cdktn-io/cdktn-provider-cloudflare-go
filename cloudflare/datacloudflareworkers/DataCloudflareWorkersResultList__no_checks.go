...
func (d *jsiiProxy_DataCloudflareWorkersResultList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataCloudflareWorkersResultList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataCloudflareWorkersResultListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
