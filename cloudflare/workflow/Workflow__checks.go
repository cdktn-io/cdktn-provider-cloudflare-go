...
func (w *jsiiProxy_Workflow) validatePutSchedulesParameters(value interface{}) error {
	...
	case []*WorkflowSchedules:
		value_ := value.([]*WorkflowSchedules)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (j *jsiiProxy_Workflow) validateSetAccountIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Workflow) validateSetClassNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Workflow) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
...
func (j *jsiiProxy_Workflow) validateSetScriptNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Workflow) validateSetWorkflowNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
