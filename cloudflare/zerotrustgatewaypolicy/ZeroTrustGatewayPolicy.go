...
func (z *jsiiProxy_ZeroTrustGatewayPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustGatewayPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustGatewayPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
