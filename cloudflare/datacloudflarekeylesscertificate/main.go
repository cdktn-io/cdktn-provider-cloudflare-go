...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keylessCertificateId", GoGetter: "KeylessCertificateId"},
			_jsii_.MemberProperty{JsiiProperty: "keylessCertificateIdInput", GoGetter: "KeylessCertificateIdInput"},
