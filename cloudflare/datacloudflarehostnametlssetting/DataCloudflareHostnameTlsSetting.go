...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflarehostnametlssetting/internal"
...
func (j *jsiiProxy_DataCloudflareHostnameTlsSetting) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareHostnameTlsSetting) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareHostnameTlsSetting) Provider() cdktf.TerraformProvider {
...
func DataCloudflareHostnameTlsSetting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareHostnameTlsSetting) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareHostnameTlsSetting) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
