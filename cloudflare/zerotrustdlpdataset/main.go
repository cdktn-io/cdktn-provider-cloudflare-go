...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "encodingVersion", GoGetter: "EncodingVersion"},
			_jsii_.MemberProperty{JsiiProperty: "encodingVersionInput", GoGetter: "EncodingVersionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maxCells", GoGetter: "MaxCells"},
			...
			_jsii_.MemberProperty{JsiiProperty: "numCells", GoGetter: "NumCells"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEncodingVersion", GoMethod: "ResetEncodingVersion"},
