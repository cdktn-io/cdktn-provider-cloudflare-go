...
func (l *jsiiProxy_LoadBalancerPool) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (l *jsiiProxy_LoadBalancerPool) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (l *jsiiProxy_LoadBalancerPool) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (l *jsiiProxy_LoadBalancerPool) validatePutOriginsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LoadBalancerPoolOrigins; received %#v (a %T)", value, value)
		}
	}
...
func validateLoadBalancerPool_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
