...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap {
	_init_.Initialize()
...
func NewDataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap_Override(d DataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePagesProjectDeploymentConfigsProductionBrowsersMap) Resolve(context cdktf.IResolveContext) interface{} {
