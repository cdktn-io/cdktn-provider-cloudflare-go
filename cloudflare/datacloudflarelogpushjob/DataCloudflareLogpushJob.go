...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflarelogpushjob/internal"
...
func (j *jsiiProxy_DataCloudflareLogpushJob) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareLogpushJob) Enabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareLogpushJob) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareLogpushJob) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareLogpushJob) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareLogpushJob) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareLogpushJob)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareLogpushJob)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareLogpushJob)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareLogpushJob_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareLogpushJob) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareLogpushJob) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareLogpushJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareLogpushJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
