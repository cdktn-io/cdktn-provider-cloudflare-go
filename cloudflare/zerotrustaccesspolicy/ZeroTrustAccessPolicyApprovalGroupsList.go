...
func (j *jsiiProxy_ZeroTrustAccessPolicyApprovalGroupsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustAccessPolicyApprovalGroupsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustAccessPolicyApprovalGroupsList {
	_init_.Initialize()
...
func NewZeroTrustAccessPolicyApprovalGroupsList_Override(z ZeroTrustAccessPolicyApprovalGroupsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustAccessPolicyApprovalGroupsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyApprovalGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyApprovalGroupsList) Resolve(context cdktn.IResolveContext) interface{} {
