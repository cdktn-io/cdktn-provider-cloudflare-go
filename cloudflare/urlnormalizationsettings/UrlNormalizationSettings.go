...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/urlnormalizationsettings/internal"
...
func (u *jsiiProxy_UrlNormalizationSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UrlNormalizationSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (u *jsiiProxy_UrlNormalizationSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
