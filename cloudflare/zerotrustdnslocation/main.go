...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "clientDefaultInput", GoGetter: "ClientDefaultInput"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "createdAt", GoGetter: "CreatedAt"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "dnsDestinationIpsId", GoGetter: "DnsDestinationIpsId"},
			_jsii_.MemberProperty{JsiiProperty: "dnsDestinationIpsIdInput", GoGetter: "DnsDestinationIpsIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "dnsDestinationIpv6BlockId", GoGetter: "DnsDestinationIpv6BlockId"},
			_jsii_.MemberProperty{JsiiProperty: "dohSubdomain", GoGetter: "DohSubdomain"},
			_jsii_.MemberProperty{JsiiProperty: "ecsSupport", GoGetter: "EcsSupport"},
			_jsii_.MemberProperty{JsiiProperty: "ecsSupportInput", GoGetter: "EcsSupportInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv4DestinationBackup", GoGetter: "Ipv4DestinationBackup"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "networksInput", GoGetter: "NetworksInput"},
			_jsii_.MemberMethod{JsiiMethod: "putNetworks", GoMethod: "PutNetworks"},
			_jsii_.MemberProperty{JsiiProperty: "requireToken", GoGetter: "RequireToken"},
			_jsii_.MemberProperty{JsiiProperty: "requireTokenInput", GoGetter: "RequireTokenInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabled", GoMethod: "ResetEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetNetworks", GoMethod: "ResetNetworks"},
			_jsii_.MemberMethod{JsiiMethod: "resetRequireToken", GoMethod: "ResetRequireToken"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "doh", GoGetter: "Doh"},
			_jsii_.MemberProperty{JsiiProperty: "dohInput", GoGetter: "DohInput"},
			_jsii_.MemberProperty{JsiiProperty: "dot", GoGetter: "Dot"},
			_jsii_.MemberProperty{JsiiProperty: "dotInput", GoGetter: "DotInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDoh", GoMethod: "PutDoh"},
			_jsii_.MemberMethod{JsiiMethod: "putDot", GoMethod: "PutDot"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.zeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtl",
		reflect.TypeOf((*ZeroTrustDnsLocationMaxTtl)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.zeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtlOutputReference",
		reflect.TypeOf((*ZeroTrustDnsLocationMaxTtlOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTtlSecs", GoMethod: "ResetTtlSecs"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "ttlSecs", GoGetter: "TtlSecs"},
			_jsii_.MemberProperty{JsiiProperty: "ttlSecsInput", GoGetter: "TtlSecsInput"},
		},
		func() interface{} {
