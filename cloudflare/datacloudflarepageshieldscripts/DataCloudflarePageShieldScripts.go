...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) DomainReportedMalicious() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) UrlContainsCdnCgiPath() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts) UrlReportedMalicious() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/page_shield_scripts cloudflare_page_shield_scripts} Data Source.
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflarePageShieldScripts)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflarePageShieldScripts_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflarePageShieldScripts) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePageShieldScripts) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePageShieldScripts) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
