...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareMagicTransitSiteLan.DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions",
		reflect.TypeOf((*DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
