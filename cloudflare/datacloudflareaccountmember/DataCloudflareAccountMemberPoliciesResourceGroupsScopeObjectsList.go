...
func (j *jsiiProxy_DataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList {
	_init_.Initialize()
...
func NewDataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList_Override(d DataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareAccountMemberPoliciesResourceGroupsScopeObjectsList) Resolve(context cdktn.IResolveContext) interface{} {
