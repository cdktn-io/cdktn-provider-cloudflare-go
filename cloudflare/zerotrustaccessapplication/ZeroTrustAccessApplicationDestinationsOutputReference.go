...
func (z *jsiiProxy_ZeroTrustAccessApplicationDestinationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationDestinationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
