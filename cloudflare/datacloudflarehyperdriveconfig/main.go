...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hyperdriveId", GoGetter: "HyperdriveId"},
			_jsii_.MemberProperty{JsiiProperty: "hyperdriveIdInput", GoGetter: "HyperdriveIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "restartedOn", GoGetter: "RestartedOn"},
