...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hasBusinessZones", GoGetter: "HasBusinessZones"},
			_jsii_.MemberProperty{JsiiProperty: "hasEnterpriseZones", GoGetter: "HasEnterpriseZones"},
			_jsii_.MemberProperty{JsiiProperty: "hasProZones", GoGetter: "HasProZones"},
