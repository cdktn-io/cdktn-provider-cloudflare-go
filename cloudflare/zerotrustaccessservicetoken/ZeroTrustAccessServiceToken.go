...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/zerotrustaccessservicetoken/internal"
...
func (j *jsiiProxy_ZeroTrustAccessServiceToken) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustAccessServiceToken) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustAccessServiceToken) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func ZeroTrustAccessServiceToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustAccessServiceToken) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessServiceToken) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustAccessServiceToken) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
