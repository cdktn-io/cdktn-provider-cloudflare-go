...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestsResultList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareCloudforceOneRequestsResultList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataCloudflareCloudforceOneRequestsResultList {
	_init_.Initialize()
...
func NewDataCloudflareCloudforceOneRequestsResultList_Override(d DataCloudflareCloudforceOneRequestsResultList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestsResultList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestsResultList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestsResultList) Resolve(context cdktn.IResolveContext) interface{} {
