...
func (d *jsiiProxy_DataCloudflareAccountRolePermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareAccountRolePermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
