...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomOriginTrustStores)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareCustomOriginTrustStoresResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
