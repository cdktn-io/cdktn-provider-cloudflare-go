...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflarecloudforceonerequestasset/internal"
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func DataCloudflareCloudforceOneRequestAsset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareCloudforceOneRequestAsset) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
