...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zerotrustdevicesettings/internal"
...
func (j *jsiiProxy_ZeroTrustDeviceSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustDeviceSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustDeviceSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustDeviceSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustDeviceSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZeroTrustDeviceSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZeroTrustDeviceSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZeroTrustDeviceSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZeroTrustDeviceSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustDeviceSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDeviceSettings) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustDeviceSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDeviceSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDeviceSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustDeviceSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
