...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/r2manageddomain/internal"
...
func (j *jsiiProxy_R2ManagedDomain) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_R2ManagedDomain) BucketId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketId",
...
func (j *jsiiProxy_R2ManagedDomain) BucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketName",
...
func (j *jsiiProxy_R2ManagedDomain) BucketNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketNameInput",
...
func (j *jsiiProxy_R2ManagedDomain) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_R2ManagedDomain) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_R2ManagedDomain) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_R2ManagedDomain) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_R2ManagedDomain) Node() constructs.Node {
...
func (j *jsiiProxy_R2ManagedDomain) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewR2ManagedDomain(scope constructs.Construct, id *string, config *R2ManagedDomainConfig) R2ManagedDomain {
	...
	if err := validateNewR2ManagedDomainParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func R2ManagedDomain_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.r2ManagedDomain.R2ManagedDomain",
...
func (r *jsiiProxy_R2ManagedDomain) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_R2ManagedDomain) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (r *jsiiProxy_R2ManagedDomain) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (r *jsiiProxy_R2ManagedDomain) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (r *jsiiProxy_R2ManagedDomain) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (r *jsiiProxy_R2ManagedDomain) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (r *jsiiProxy_R2ManagedDomain) GetStringAttribute(terraformAttribute *string) *string {
...
func (r *jsiiProxy_R2ManagedDomain) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (r *jsiiProxy_R2ManagedDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_R2ManagedDomain) MoveFromId(id *string) {
...
func (r *jsiiProxy_R2ManagedDomain) MoveToId(id *string) {
...
func (r *jsiiProxy_R2ManagedDomain) OverrideLogicalId(newLogicalId *string) {
...
func (r *jsiiProxy_R2ManagedDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_R2ManagedDomain) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		r,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (r *jsiiProxy_R2ManagedDomain) ToString() *string {
	var returns *string
