...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "beginVerification", GoGetter: "BeginVerification"},
			_jsii_.MemberProperty{JsiiProperty: "beginVerificationInput", GoGetter: "BeginVerificationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBeginVerification", GoMethod: "ResetBeginVerification"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabled", GoMethod: "ResetEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetUseFedrampLanguage", GoMethod: "ResetUseFedrampLanguage"},
			...
			_jsii_.MemberProperty{JsiiProperty: "useFedrampLanguageInput", GoGetter: "UseFedrampLanguageInput"},
