...
func (j *jsiiProxy_ZeroTrustDlpIntegrationEntry) Deprecated() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"deprecated",
...
func (z *jsiiProxy_ZeroTrustDlpIntegrationEntry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustDlpIntegrationEntry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustDlpIntegrationEntry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
