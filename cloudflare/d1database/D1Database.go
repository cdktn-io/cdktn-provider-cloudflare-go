...
func (d *jsiiProxy_D1Database) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_D1Database) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_D1Database) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_D1Database) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
