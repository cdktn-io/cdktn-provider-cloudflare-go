...
func (j *jsiiProxy_ZeroTrustDnsLocationEndpointsDohNetworksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustDnsLocationEndpointsDohNetworksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDnsLocationEndpointsDohNetworksList {
	_init_.Initialize()
...
func NewZeroTrustDnsLocationEndpointsDohNetworksList_Override(z ZeroTrustDnsLocationEndpointsDohNetworksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDnsLocationEndpointsDohNetworksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDnsLocationEndpointsDohNetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDnsLocationEndpointsDohNetworksList) Resolve(context cdktn.IResolveContext) interface{} {
