...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/turnstilewidget/internal"
...
func (j *jsiiProxy_TurnstileWidget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TurnstileWidget) DeployedVia() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deployedVia",
...
func (j *jsiiProxy_TurnstileWidget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TurnstileWidget) LastModifiedVia() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedVia",
...
func (j *jsiiProxy_TurnstileWidget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TurnstileWidget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TurnstileWidget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TurnstileWidget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TurnstileWidget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TurnstileWidget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TurnstileWidget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TurnstileWidget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TurnstileWidget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TurnstileWidget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TurnstileWidget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
