...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aiContextEnabledInput", GoGetter: "AiContextEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enabledEntriesInput", GoGetter: "EnabledEntriesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ocrEnabledInput", GoGetter: "OcrEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnabledEntries", GoMethod: "ResetEnabledEntries"},
