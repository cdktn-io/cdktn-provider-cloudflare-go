...
func (j *jsiiProxy_MagicWanStaticRoute) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_MagicWanStaticRoute) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_MagicWanStaticRoute) Provider() cdktf.TerraformProvider {
...
func MagicWanStaticRoute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MagicWanStaticRoute) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MagicWanStaticRoute) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MagicWanStaticRoute) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
