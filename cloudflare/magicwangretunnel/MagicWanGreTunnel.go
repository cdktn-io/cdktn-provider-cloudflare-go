...
func (m *jsiiProxy_MagicWanGreTunnel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MagicWanGreTunnel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MagicWanGreTunnel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
