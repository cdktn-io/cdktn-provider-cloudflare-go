...
func (p *jsiiProxy_PagesProjectCanonicalDeploymentSourceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PagesProjectCanonicalDeploymentSourceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
