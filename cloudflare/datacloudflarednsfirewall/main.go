...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dnsFirewallId", GoGetter: "DnsFirewallId"},
			_jsii_.MemberProperty{JsiiProperty: "dnsFirewallIdInput", GoGetter: "DnsFirewallIdInput"},
