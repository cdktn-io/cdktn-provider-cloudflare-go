...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/tieredcache/internal"
...
func (j *jsiiProxy_TieredCache) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TieredCache) Editable() cdktn.IResolvable {
...
func (j *jsiiProxy_TieredCache) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TieredCache) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TieredCache) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TieredCache) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TieredCache)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TieredCache)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TieredCache)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TieredCache_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TieredCache) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TieredCache) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TieredCache) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TieredCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TieredCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TieredCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
