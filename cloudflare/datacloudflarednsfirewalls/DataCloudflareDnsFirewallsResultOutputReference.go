...
func (j *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) DeprecateAnyRequests() cdktn.IResolvable {
...
func (j *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) EcsFallback() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ecsFallback",
...
func (j *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareDnsFirewallsResultOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataCloudflareDnsFirewallsResultOutputReference {
	_init_.Initialize()
...
func NewDataCloudflareDnsFirewallsResultOutputReference_Override(d DataCloudflareDnsFirewallsResultOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsFirewallsResultOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
