...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putManagedBy", GoMethod: "PutManagedBy"},
			_jsii_.MemberMethod{JsiiMethod: "putSettings", GoMethod: "PutSettings"},
			_jsii_.MemberMethod{JsiiMethod: "putUnit", GoMethod: "PutUnit"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.account.AccountManagedBy",
		reflect.TypeOf((*AccountManagedBy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.account.AccountManagedByOutputReference",
		reflect.TypeOf((*AccountManagedByOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAbuseContactEmail", GoMethod: "ResetAbuseContactEmail"},
