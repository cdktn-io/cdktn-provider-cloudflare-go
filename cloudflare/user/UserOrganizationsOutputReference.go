...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v14/user/internal"
...
type UserOrganizationsOutputReference interface {
	...
	Fqn() *string
	Id() *string
	InternalValue() *UserOrganizations
	SetInternalValue(val *UserOrganizations)
	Name() *string
	Permissions() *[]*string
	Roles() *[]*string
	Status() *string
...
func (j *jsiiProxy_UserOrganizationsOutputReference) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserOrganizationsOutputReference) InternalValue() *UserOrganizations {
	var returns *UserOrganizations
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_UserOrganizationsOutputReference) Permissions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissions",
...
func (j *jsiiProxy_UserOrganizationsOutputReference) Roles() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roles",
...
func (j *jsiiProxy_UserOrganizationsOutputReference) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_UserOrganizationsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewUserOrganizationsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) UserOrganizationsOutputReference {
	_init_.Initialize()
...
func NewUserOrganizationsOutputReference_Override(u UserOrganizationsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_UserOrganizationsOutputReference)SetInternalValue(val *UserOrganizations) {
...
func (j *jsiiProxy_UserOrganizationsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (u *jsiiProxy_UserOrganizationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserOrganizationsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (u *jsiiProxy_UserOrganizationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserOrganizationsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
