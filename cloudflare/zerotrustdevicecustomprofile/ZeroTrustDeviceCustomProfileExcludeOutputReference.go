...
func (j *jsiiProxy_ZeroTrustDeviceCustomProfileExcludeOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewZeroTrustDeviceCustomProfileExcludeOutputReference_Override(z ZeroTrustDeviceCustomProfileExcludeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileExcludeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileExcludeOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustDeviceCustomProfileExcludeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
