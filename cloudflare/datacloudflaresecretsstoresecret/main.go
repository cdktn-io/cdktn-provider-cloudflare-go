...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareSecretsStoreSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareSecretsStoreSecret.DataCloudflareSecretsStoreSecretConfig",
		reflect.TypeOf((*DataCloudflareSecretsStoreSecretConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareSecretsStoreSecret.DataCloudflareSecretsStoreSecretFilter",
		reflect.TypeOf((*DataCloudflareSecretsStoreSecretFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareSecretsStoreSecret.DataCloudflareSecretsStoreSecretFilterOutputReference",
		reflect.TypeOf((*DataCloudflareSecretsStoreSecretFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
