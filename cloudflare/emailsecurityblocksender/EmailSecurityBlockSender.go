...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/emailsecurityblocksender/internal"
...
func (e *jsiiProxy_EmailSecurityBlockSender) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EmailSecurityBlockSender) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EmailSecurityBlockSender) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
