...
func (j *jsiiProxy_CertificatePackValidationRecordsOutputReference) InternalValue() *CertificatePackValidationRecords {
	var returns *CertificatePackValidationRecords
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_CertificatePackValidationRecordsOutputReference)SetInternalValue(val *CertificatePackValidationRecords) {
