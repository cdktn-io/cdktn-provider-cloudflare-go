...
func (j *jsiiProxy_MagicTransitSiteLanRoutedSubnetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMagicTransitSiteLanRoutedSubnetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MagicTransitSiteLanRoutedSubnetsList {
	_init_.Initialize()
...
func NewMagicTransitSiteLanRoutedSubnetsList_Override(m MagicTransitSiteLanRoutedSubnetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MagicTransitSiteLanRoutedSubnetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MagicTransitSiteLanRoutedSubnetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MagicTransitSiteLanRoutedSubnetsList) Resolve(context cdktn.IResolveContext) interface{} {
