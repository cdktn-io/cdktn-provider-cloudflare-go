...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPolicyExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPolicyExcludeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
