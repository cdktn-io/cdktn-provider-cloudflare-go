...
type DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference interface {
	...
	CloudflareAccountMember() DataCloudflareZeroTrustAccessPoliciesResultRequireCloudflareAccountMemberOutputReference
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference) CloudflareAccountMember() DataCloudflareZeroTrustAccessPoliciesResultRequireCloudflareAccountMemberOutputReference {
	var returns DataCloudflareZeroTrustAccessPoliciesResultRequireCloudflareAccountMemberOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference {
	_init_.Initialize()
...
func NewDataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference_Override(d DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareZeroTrustAccessPoliciesResultRequireOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
