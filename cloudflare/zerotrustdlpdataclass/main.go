...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustDlpDataClass)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.zeroTrustDlpDataClass.ZeroTrustDlpDataClassConfig",
		reflect.TypeOf((*ZeroTrustDlpDataClassConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.zeroTrustDlpDataClass.ZeroTrustDlpDataClassSensitivityLevels",
		reflect.TypeOf((*ZeroTrustDlpDataClassSensitivityLevels)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.zeroTrustDlpDataClass.ZeroTrustDlpDataClassSensitivityLevelsList",
		reflect.TypeOf((*ZeroTrustDlpDataClassSensitivityLevelsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustDlpDataClassSensitivityLevelsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
