...
func (j *jsiiProxy_ZeroTrustTunnelWarpConnector) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustTunnelWarpConnector) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustTunnelWarpConnector) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustTunnelWarpConnector) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustTunnelWarpConnector) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func ZeroTrustTunnelWarpConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (z *jsiiProxy_ZeroTrustTunnelWarpConnector) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustTunnelWarpConnector) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustTunnelWarpConnector) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
