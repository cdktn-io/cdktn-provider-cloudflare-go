...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPagesProjectDeploymentConfigsPreviewOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PagesProjectDeploymentConfigsPreviewOutputReference {
	_init_.Initialize()
...
func NewPagesProjectDeploymentConfigsPreviewOutputReference_Override(p PagesProjectDeploymentConfigsPreviewOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PagesProjectDeploymentConfigsPreviewOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PagesProjectDeploymentConfigsPreviewOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
