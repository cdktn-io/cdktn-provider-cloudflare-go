...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v13/datacloudflareobservatoryscheduledtest/internal"
...
func (j *jsiiProxy_DataCloudflareObservatoryScheduledTest) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareObservatoryScheduledTest) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareObservatoryScheduledTest) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareObservatoryScheduledTest) Provider() cdktf.TerraformProvider {
...
func DataCloudflareObservatoryScheduledTest_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareObservatoryScheduledTest) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareObservatoryScheduledTest) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
