...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "keylessServer", GoGetter: "KeylessServer"},
			...
			_jsii_.MemberProperty{JsiiProperty: "policyRestrictions", GoGetter: "PolicyRestrictions"},
