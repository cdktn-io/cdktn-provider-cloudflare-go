...
type ZeroTrustAccessPolicyExcludeOutputReference interface {
	...
	UserRiskScore() ZeroTrustAccessPolicyExcludeUserRiskScoreOutputReference
	...
	PutUserRiskScore(value *ZeroTrustAccessPolicyExcludeUserRiskScore)
...
func (j *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) UserRiskScore() ZeroTrustAccessPolicyExcludeUserRiskScoreOutputReference {
	var returns ZeroTrustAccessPolicyExcludeUserRiskScoreOutputReference
	_jsii_.Get(
		j,
		"userRiskScore",
		&returns,
...
func (j *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) UserRiskScoreInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"userRiskScoreInput",
...
func NewZeroTrustAccessPolicyExcludeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ZeroTrustAccessPolicyExcludeOutputReference {
	_init_.Initialize()
...
func NewZeroTrustAccessPolicyExcludeOutputReference_Override(z ZeroTrustAccessPolicyExcludeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) PutUserRiskScore(value *ZeroTrustAccessPolicyExcludeUserRiskScore) {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) ResetUserRiskScore() {
	_jsii_.InvokeVoid(
		z,
		"resetUserRiskScore",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
