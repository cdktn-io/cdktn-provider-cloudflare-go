...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareOrganization.DataCloudflareOrganizationMetaTenantFlags",
		reflect.TypeOf((*DataCloudflareOrganizationMetaTenantFlags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareOrganization.DataCloudflareOrganizationMetaTenantFlagsOutputReference",
		reflect.TypeOf((*DataCloudflareOrganizationMetaTenantFlagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
