...
func (a *jsiiProxy_ApiShieldOperationFeaturesThresholdsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiShieldOperationFeaturesThresholdsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
