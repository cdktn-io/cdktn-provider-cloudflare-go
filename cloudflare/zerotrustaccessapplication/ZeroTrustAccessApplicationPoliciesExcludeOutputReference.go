...
type ZeroTrustAccessApplicationPoliciesExcludeOutputReference interface {
	...
	LinkedAppToken() ZeroTrustAccessApplicationPoliciesExcludeLinkedAppTokenOutputReference
	...
	PutLinkedAppToken(value *ZeroTrustAccessApplicationPoliciesExcludeLinkedAppToken)
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) LinkedAppToken() ZeroTrustAccessApplicationPoliciesExcludeLinkedAppTokenOutputReference {
	var returns ZeroTrustAccessApplicationPoliciesExcludeLinkedAppTokenOutputReference
	_jsii_.Get(
		j,
		"linkedAppToken",
		&returns,
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) LinkedAppTokenInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"linkedAppTokenInput",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) OidcInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"oidcInput",
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustAccessApplicationPoliciesExcludeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ZeroTrustAccessApplicationPoliciesExcludeOutputReference {
	_init_.Initialize()
...
func NewZeroTrustAccessApplicationPoliciesExcludeOutputReference_Override(z ZeroTrustAccessApplicationPoliciesExcludeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) PutLinkedAppToken(value *ZeroTrustAccessApplicationPoliciesExcludeLinkedAppToken) {
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) ResetLinkedAppToken() {
	_jsii_.InvokeVoid(
		z,
		"resetLinkedAppToken",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessApplicationPoliciesExcludeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
