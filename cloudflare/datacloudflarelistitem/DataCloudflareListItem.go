...
type jsiiProxy_DataCloudflareListItem struct {
...
func (j *jsiiProxy_DataCloudflareListItem) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareListItem) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareListItem) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareListItem) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareListItem) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareListItem) ItemId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"itemId",
...
func (j *jsiiProxy_DataCloudflareListItem) ItemIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"itemIdInput",
...
func (j *jsiiProxy_DataCloudflareListItem) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareListItem) ListId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"listId",
...
func (j *jsiiProxy_DataCloudflareListItem) ListIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"listIdInput",
...
func (j *jsiiProxy_DataCloudflareListItem) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareListItem) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareListItem) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataCloudflareListItem(scope constructs.Construct, id *string, config *DataCloudflareListItemConfig) DataCloudflareListItem {
	...
	if err := validateNewDataCloudflareListItemParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataCloudflareListItem)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataCloudflareListItem)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataCloudflareListItem)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataCloudflareListItem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateDataCloudflareListItem_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataCloudflareListItem_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.dataCloudflareListItem.DataCloudflareListItem",
...
func (d *jsiiProxy_DataCloudflareListItem) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareListItem) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareListItem) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareListItem) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareListItem) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareListItem) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareListItem) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareListItem) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareListItem) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataCloudflareListItem) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareListItem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataCloudflareListItem) ResetAccountId() {
	_jsii_.InvokeVoid(
		d,
		"resetAccountId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareListItem) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareListItem) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataCloudflareListItem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
