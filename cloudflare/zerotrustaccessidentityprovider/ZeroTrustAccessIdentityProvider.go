...
type jsiiProxy_ZeroTrustAccessIdentityProvider struct {
	internal.Type__cdktnTerraformResource
}

func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewZeroTrustAccessIdentityProvider(scope constructs.Construct, id *string, config *ZeroTrustAccessIdentityProviderConfig) ZeroTrustAccessIdentityProvider {
	...
	if err := validateNewZeroTrustAccessIdentityProviderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ZeroTrustAccessIdentityProvider)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ZeroTrustAccessIdentityProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateZeroTrustAccessIdentityProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ResetAccountId() {
	_jsii_.InvokeVoid(
		z,
		"resetAccountId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ResetScimConfig() {
	_jsii_.InvokeVoid(
		z,
		"resetScimConfig",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ResetZoneId() {
	_jsii_.InvokeVoid(
		z,
		"resetZoneId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustAccessIdentityProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
