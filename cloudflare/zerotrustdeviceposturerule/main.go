...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authStateInput", GoGetter: "AuthStateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthState", GoMethod: "ResetAuthState"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUpdateWindowDays", GoMethod: "ResetUpdateWindowDays"},
			...
			_jsii_.MemberProperty{JsiiProperty: "updateWindowDaysInput", GoGetter: "UpdateWindowDaysInput"},
