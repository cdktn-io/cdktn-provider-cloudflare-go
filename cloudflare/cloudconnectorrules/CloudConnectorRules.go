...
func (j *jsiiProxy_CloudConnectorRules) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_CloudConnectorRules) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_CloudConnectorRules) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.14.0/docs/resources/cloud_connector_rules cloudflare_cloud_connector_rules} Resource.
...
func CloudConnectorRules_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudConnectorRules) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudConnectorRules) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CloudConnectorRules) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
