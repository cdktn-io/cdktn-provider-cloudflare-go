...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "botFightModeInput", GoGetter: "BotFightModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "clearanceLevel", GoGetter: "ClearanceLevel"},
			_jsii_.MemberProperty{JsiiProperty: "clearanceLevelInput", GoGetter: "ClearanceLevelInput"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "createdOn", GoGetter: "CreatedOn"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "deployedVia", GoGetter: "DeployedVia"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ephemeralId", GoGetter: "EphemeralId"},
			_jsii_.MemberProperty{JsiiProperty: "ephemeralIdInput", GoGetter: "EphemeralIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "lastModifiedVia", GoGetter: "LastModifiedVia"},
			...
			_jsii_.MemberProperty{JsiiProperty: "offlabel", GoGetter: "Offlabel"},
			_jsii_.MemberProperty{JsiiProperty: "offlabelInput", GoGetter: "OfflabelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOfflabel", GoMethod: "ResetOfflabel"},
