...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/image/internal"
...
func (j *jsiiProxy_Image) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_Image) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_Image) Creator() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creator",
...
func (j *jsiiProxy_Image) CreatorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creatorInput",
...
func (j *jsiiProxy_Image) File() *string {
	var returns *string
	_jsii_.Get(
		j,
		"file",
...
func (j *jsiiProxy_Image) FileInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fileInput",
...
func (j *jsiiProxy_Image) Filename() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filename",
...
func (j *jsiiProxy_Image) Meta() *string {
	var returns *string
	_jsii_.Get(
		j,
		"meta",
...
func (j *jsiiProxy_Image) Metadata() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metadata",
...
func (j *jsiiProxy_Image) MetadataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metadataInput",
...
func (j *jsiiProxy_Image) Uploaded() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uploaded",
...
func (j *jsiiProxy_Image) UrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"urlInput",
...
func (j *jsiiProxy_Image) Variants() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"variants",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/image cloudflare_image} Resource.
...
func (j *jsiiProxy_Image)SetCreator(val *string) {
...
func (i *jsiiProxy_Image) ResetCreator() {
	_jsii_.InvokeVoid(
		i,
		"resetCreator",
		nil, // no parameters
...
func (i *jsiiProxy_Image) ResetFile() {
	_jsii_.InvokeVoid(
		i,
		"resetFile",
		nil, // no parameters
...
func (i *jsiiProxy_Image) ResetMetadata() {
	_jsii_.InvokeVoid(
		i,
		"resetMetadata",
		nil, // no parameters
...
func (i *jsiiProxy_Image) ResetRequireSignedUrls() {
	_jsii_.InvokeVoid(
		i,
		"resetRequireSignedUrls",
		nil, // no parameters
...
func (i *jsiiProxy_Image) ResetUrl() {
	_jsii_.InvokeVoid(
		i,
		"resetUrl",
		nil, // no parameters
