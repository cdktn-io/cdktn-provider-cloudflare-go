...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustGatewayPacfile)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pacfileId", GoGetter: "PacfileId"},
			_jsii_.MemberProperty{JsiiProperty: "pacfileIdInput", GoGetter: "PacfileIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataCloudflareZeroTrustGatewayPacfileConfig)(nil)).Elem(),
	)
}
