...
func (d *jsiiProxy_DataCloudflareDnsRecordFilterCommentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareDnsRecordFilterCommentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
