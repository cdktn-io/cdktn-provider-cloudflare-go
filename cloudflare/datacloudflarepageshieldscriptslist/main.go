...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "excludeDuplicates", GoGetter: "ExcludeDuplicates"},
			_jsii_.MemberProperty{JsiiProperty: "excludeDuplicatesInput", GoGetter: "ExcludeDuplicatesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeDuplicates", GoMethod: "ResetExcludeDuplicates"},
