...
func (w *jsiiProxy_WorkerVersionMigrationsTransferredClassesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WorkerVersionMigrationsTransferredClassesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
