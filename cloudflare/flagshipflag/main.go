...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlagshipFlag)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFlagKey", GoMethod: "ResetFlagKey"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagConfig",
		reflect.TypeOf((*FlagshipFlagConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRules",
		reflect.TypeOf((*FlagshipFlagRules)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRulesConditions",
		reflect.TypeOf((*FlagshipFlagRulesConditions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRulesConditionsClauses",
		reflect.TypeOf((*FlagshipFlagRulesConditionsClauses)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRulesConditionsClausesList",
		reflect.TypeOf((*FlagshipFlagRulesConditionsClausesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlagshipFlagRulesConditionsClausesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlagshipFlagRulesConditionsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlagshipFlagRulesConditionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attribute", GoGetter: "Attribute"},
			_jsii_.MemberProperty{JsiiProperty: "attributeInput", GoGetter: "AttributeInput"},
			_jsii_.MemberProperty{JsiiProperty: "clauses", GoGetter: "Clauses"},
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRulesList",
		reflect.TypeOf((*FlagshipFlagRulesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_FlagshipFlagRulesList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlagshipFlagRulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serveVariationInput", GoGetter: "ServeVariationInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRulesRollout",
		reflect.TypeOf((*FlagshipFlagRulesRollout)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.flagshipFlag.FlagshipFlagRulesRolloutOutputReference",
		reflect.TypeOf((*FlagshipFlagRulesRolloutOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attribute", GoGetter: "Attribute"},
			_jsii_.MemberProperty{JsiiProperty: "attributeInput", GoGetter: "AttributeInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
