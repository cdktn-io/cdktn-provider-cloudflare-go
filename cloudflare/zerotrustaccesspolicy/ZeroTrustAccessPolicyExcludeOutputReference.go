...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (z *jsiiProxy_ZeroTrustAccessPolicyExcludeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
