...
func (j *jsiiProxy_R2BucketLock) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_R2BucketLock) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_R2BucketLock) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_R2BucketLock) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_R2BucketLock) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func R2BucketLock_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_R2BucketLock) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_R2BucketLock) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_R2BucketLock) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
