...
func (j *jsiiProxy_WorkerVersion) ExportsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"exportsInput",
...
func (w *jsiiProxy_WorkerVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WorkerVersion) PutExports(value interface{}) {
...
func (w *jsiiProxy_WorkerVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WorkerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
