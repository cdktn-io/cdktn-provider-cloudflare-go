...
func (j *jsiiProxy_DataCloudflareSchemaValidationSchemasList) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareSchemaValidationSchemasList) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataCloudflareSchemaValidationSchemasList) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareSchemaValidationSchemasList) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareSchemaValidationSchemasList) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.12.0/docs/data-sources/schema_validation_schemas_list cloudflare_schema_validation_schemas_list} Data Source.
...
func DataCloudflareSchemaValidationSchemasList_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataCloudflareSchemaValidationSchemasList) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareSchemaValidationSchemasList) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
