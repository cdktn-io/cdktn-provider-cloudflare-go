...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/customhostnamefallbackorigin/internal"
...
func (c *jsiiProxy_CustomHostnameFallbackOrigin) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomHostnameFallbackOrigin) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomHostnameFallbackOrigin) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
