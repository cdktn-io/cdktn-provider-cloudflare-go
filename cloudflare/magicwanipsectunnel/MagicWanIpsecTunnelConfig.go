...
type MagicWanIpsecTunnelConfig struct {
	...
	AutomaticReturnRouting interface{} `field:"optional" json:"automaticReturnRouting" yaml:"automaticReturnRouting"`
	...
	Bgp *MagicWanIpsecTunnelBgp `field:"optional" json:"bgp" yaml:"bgp"`
	...
	CustomRemoteIdentities *MagicWanIpsecTunnelCustomRemoteIdentities `field:"optional" json:"customRemoteIdentities" yaml:"customRemoteIdentities"`
