...
func (j *jsiiProxy_ZeroTrustDlpCustomProfileSharedEntriesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewZeroTrustDlpCustomProfileSharedEntriesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ZeroTrustDlpCustomProfileSharedEntriesList {
	_init_.Initialize()
...
func NewZeroTrustDlpCustomProfileSharedEntriesList_Override(z ZeroTrustDlpCustomProfileSharedEntriesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ZeroTrustDlpCustomProfileSharedEntriesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (z *jsiiProxy_ZeroTrustDlpCustomProfileSharedEntriesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (z *jsiiProxy_ZeroTrustDlpCustomProfileSharedEntriesList) Resolve(context cdktn.IResolveContext) interface{} {
