...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareShareResourcesA)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareShareResources.DataCloudflareShareResourcesAConfig",
		reflect.TypeOf((*DataCloudflareShareResourcesAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-cloudflare.dataCloudflareShareResources.DataCloudflareShareResourcesResult",
		reflect.TypeOf((*DataCloudflareShareResourcesResult)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-cloudflare.dataCloudflareShareResources.DataCloudflareShareResourcesResultList",
		reflect.TypeOf((*DataCloudflareShareResourcesResultList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareShareResourcesResultOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
