...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_access_short_lived_certificate cloudflare_zero_trust_access_short_lived_certificate}.
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) Aud() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aud",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) Node() constructs.Node {
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) PublicKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKey",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_ZeroTrustAccessShortLivedCertificate) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_access_short_lived_certificate cloudflare_zero_trust_access_short_lived_certificate} Resource.
func NewZeroTrustAccessShortLivedCertificate(scope constructs.Construct, id *string, config *ZeroTrustAccessShortLivedCertificateConfig) ZeroTrustAccessShortLivedCertificate {
	...
	if err := validateNewZeroTrustAccessShortLivedCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ZeroTrustAccessShortLivedCertificate_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-cloudflare.zeroTrustAccessShortLivedCertificate.ZeroTrustAccessShortLivedCertificate",
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) AddMoveTarget(moveTarget *string) {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetStringAttribute(terraformAttribute *string) *string {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) MoveFromId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) MoveToId(id *string) {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) OverrideLogicalId(newLogicalId *string) {
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) ResetAccountId() {
	_jsii_.InvokeVoid(
		z,
		"resetAccountId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		z,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) ResetZoneId() {
	_jsii_.InvokeVoid(
		z,
		"resetZoneId",
		nil, // no parameters
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) ToString() *string {
	var returns *string
...
func (z *jsiiProxy_ZeroTrustAccessShortLivedCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
