...
import (
	...
	"github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/notificationpolicywebhooks/internal"
...
func (n *jsiiProxy_NotificationPolicyWebhooks) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NotificationPolicyWebhooks) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NotificationPolicyWebhooks) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
