...
func (j *jsiiProxy_RulesetRulesActionParametersHeadersMap) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_RulesetRulesActionParametersHeadersMap) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (r *jsiiProxy_RulesetRulesActionParametersHeadersMap) ComputeFqn() *string {
	var returns *string
...
func (r *jsiiProxy_RulesetRulesActionParametersHeadersMap) Get(key *string) RulesetRulesActionParametersHeadersOutputReference {
...
func (r *jsiiProxy_RulesetRulesActionParametersHeadersMap) ToString() *string {
	var returns *string
